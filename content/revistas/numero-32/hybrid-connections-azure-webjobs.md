...
![Imagen 1.- Esquema de la solución.](../images/hybrid-connections-azure-webjobs/image1.png)
...
![Imagen 2.- Creación de la Web App.](../images/hybrid-connections-azure-webjobs/image2.png)

Rellenamos los datos de configuración de nuestra Web App.

![Imagen 3.- Parámetros de la Web App.](../images/hybrid-connections-azure-webjobs/image3.png)
...
![Imagen 4.- Configuración de la Web App.](../images/hybrid-connections-azure-webjobs/image4.png)
...
![Imagen 5.- Creación de la Hybrid Connection.](../images/hybrid-connections-azure-webjobs/image5.png)

Añadimos la siguiente información para configurar el Endpoint.

![Imagen 6.- Parámetros de la Hybrid Connection.](../images/hybrid-connections-azure-webjobs/image6.png)

Una vez tenemos la Hybrid Connection creada, la seleccionamos y clicamos en Add selected hybrid connection.

![Imagen 7.- Añadiendo la Hybrid Connection al Web App.](../images/hybrid-connections-azure-webjobs/image7.png)

Podemos ver en la siguiente pantalla que el estado de la conexión es Not connected.

![Imagen 8.- Estado de la Hybrid Connection.](../images/hybrid-connections-azure-webjobs/image8.png)
...
![Imagen 9.- Selección de la Hybrid Connection.](../images/hybrid-connections-azure-webjobs/image9.png)

Automáticamente y después de clicar en Save, vemos que el Azure Status ha cambiado a Connected.

![Imagen 10.- Estado de la Hybrid Connection.](../images/hybrid-connections-azure-webjobs/image10.png)

Si vamos a la configuración de la Hybrid Connection en Azure, veremos que el estado también ha cambiado a Connected.

![Si vamos a la configuración de la Hybrid Connection en Azure, veremos que el estado también ha cambiado a Connected.](../images/hybrid-connections-azure-webjobs/image11.png)
