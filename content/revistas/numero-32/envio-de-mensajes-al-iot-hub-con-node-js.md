...
slug: "envio-de-mensajes-al-iot-hub-con-node-js"
magazineSlug: "numero-32"
author: "Luis Valencia"
authorSlug: "luis-valencia"
keywords: ['Azure','Azure IoT Hub','node.js']
image: "../images/envio-de-mensajes-al-iot-hub-con-node-js/image3.png"
---
...
![Imagen 1.- Archivos JavaScript en Visual Studio Code.](../images/envio-de-mensajes-al-iot-hub-con-node-js/image1.png)

·         Módulos instalados:

![Imagen 2.- Módulos necesarios.](../images/envio-de-mensajes-al-iot-hub-con-node-js/image1d.png)
...
![](../images/envio-de-mensajes-al-iot-hub-con-node-js/image3.png)
...
![](../images/envio-de-mensajes-al-iot-hub-con-node-js/image4.png)
...
![](../images/envio-de-mensajes-al-iot-hub-con-node-js/image5.png)

Estado del robot de temperatura con el sensor BMP180:

![](../images/envio-de-mensajes-al-iot-hub-con-node-js/image1e.png)

**Sensor DHT22**
Se realiza el constructor y la herencia con el EventEmitter.

![](../images/envio-de-mensajes-al-iot-hub-con-node-js/image1f.png)

Se configura el sensor DHT y el pin de lectura de  la temperatura y la humedad relativa.

![](../images/envio-de-mensajes-al-iot-hub-con-node-js/image20.png)

Lectura del sensor DHT datos de temperatura y humedad relativa.

![](../images/envio-de-mensajes-al-iot-hub-con-node-js/image21.png)
...
![](../images/envio-de-mensajes-al-iot-hub-con-node-js/image25.png)
...
![](../images/envio-de-mensajes-al-iot-hub-con-node-js/image23.png)
...
![](../images/envio-de-mensajes-al-iot-hub-con-node-js/image24.png)
...
![](../images/envio-de-mensajes-al-iot-hub-con-node-js/image28.png)

·       Codigo JavaScript para gestionar el  socket del lado del cliente.

![](../images/envio-de-mensajes-al-iot-hub-con-node-js/image27.png)

·       Finalmente se obtienen los datos en tiempo real.

![](../images/envio-de-mensajes-al-iot-hub-con-node-js/image29.png)
