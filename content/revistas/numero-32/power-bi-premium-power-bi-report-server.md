...
![Imagen 1.- Inicio del asistente de instalación de Power BI Report Server.](../images/power-bi-premium-power-bi-report-server/imaged.png)

3.       Seleccionar la edición que se instalará:​

![Imagen 2.- Selección de la edición a instalar.](../images/power-bi-premium-power-bi-report-server/imagee.png)

4.       Leer los términos y condiciones y seguir adelante con la opción Next.

![Imagen 3.- Términos y Condiciones.](../images/power-bi-premium-power-bi-report-server/imagef.png)
...
![Imagen 4.- Pantalla de instalación del servidor de Power BI Report Server.](../images/power-bi-premium-power-bi-report-server/image10.png)

6.       Especificaremos a continuación la localización de nuestra instalación.

![Imagen 5.- Ruta de instalación de Power BI Report Server.](../images/power-bi-premium-power-bi-report-server/image11.png)

7.       Una vez que finalizamos con la instalación, seleccionaremos la opción de Configuración de Report Server.

![Imagen 6.- Opción de configuración de report server.](../images/power-bi-premium-power-bi-report-server/image12.png)

8.       Nuestra pantalla de Configuración de Report Server será la siguiente:

![Imagen 7.- Configuración de Report Server.](../images/power-bi-premium-power-bi-report-server/image13.png)
...
![Imagen 8.- Configuración del Web Service Url.](../images/power-bi-premium-power-bi-report-server/image14.png)

![Imagen 9.- Configuración del Web Portal URL.](../images/power-bi-premium-power-bi-report-server/image15.png)
...
![Imagen 10.- Opción de publicación en Power BI Report Server.](../images/power-bi-premium-power-bi-report-server/image16.png)
...
![Imagen 11.- Acceso a Power BI Report Server.](../images/power-bi-premium-power-bi-report-server/image17.png)
...
![Imagen 12.- Visualización del informe de Power BI publicado en Power BI Report Server.](../images/power-bi-premium-power-bi-report-server/image18.png)
