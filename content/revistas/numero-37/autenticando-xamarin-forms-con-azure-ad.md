...
![Imagen 1.- Creación de la aplicación en Azure AD.](../images/autenticando-xamarin-forms-con-azure-ad/image1.png)
...
![Imagen 2.- Parámetros de la aplicación.](../images/autenticando-xamarin-forms-con-azure-ad/image2.png)

Ahora nos guardaremos el Application ID que lo necesitaremos más adelante.

![Imagen 3.- Application ID.](../images/autenticando-xamarin-forms-con-azure-ad/image3.png)
...
![Imagen 4.- Creación de la API REST en Azure AD.](../images/autenticando-xamarin-forms-con-azure-ad/image4.png)
...
![Imagen 5.- Creación del secret key.](../images/autenticando-xamarin-forms-con-azure-ad/image5.png)
...
![Imagen 6.- Configuración de los permisos para la API REST.](../images/autenticando-xamarin-forms-con-azure-ad/image6.png)

Después de ello le daremos Grant Permissions a la aplicación.

![Imagen 7.- Concediendo permisos a la API REST.](../images/autenticando-xamarin-forms-con-azure-ad/image7.png)
...
![Imagen 8.- Concesión de permisos entre aplicaciones.](../images/autenticando-xamarin-forms-con-azure-ad/image8.png)

​Le daremos a Add, buscaremos nuestra aplicación API, la seleccionamos y le daremos los permisos.

![Imagen 9.- Concesión de permisos.](../images/autenticando-xamarin-forms-con-azure-ad/image9.png)
...
![Imagen 10.- Configuración del manifestó de la aplicación.](../images/autenticando-xamarin-forms-con-azure-ad/image10.png)
...
![Imagen 11.- Propiedad Directory ID.](../images/autenticando-xamarin-forms-con-azure-ad/image11.png)
...
![Imagen 12.- Proyectos Xamarin.Forms.](../images/autenticando-xamarin-forms-con-azure-ad/image12.png)
...
![Imagen 12.- Proyectos Xamarin.Forms.](../images/autenticando-xamarin-forms-con-azure-ad/image13.png)

En la imagen anterior vemos la estructura de proyectos que se nos crea, ahora debemos añadir el siguiente paquete Nugget en ambos proyectos:

![Imagen 13.- Paquetes Nugget a añadir.](../images/autenticando-xamarin-forms-con-azure-ad/image14.png)
...
![Imagen 14.- Configuración de la autenticación con Azure AD.](../images/autenticando-xamarin-forms-con-azure-ad/image15.png)

Seleccionamos la segunda opción:

![Imagen 15.- Configuración de la segunda opción.](../images/autenticando-xamarin-forms-con-azure-ad/image16.png)

​​Seleccionamos la opción de usar settings ya existentes.​

![Imagen 16.- Opción de app settings seleccionada.](../images/autenticando-xamarin-forms-con-azure-ad/image17.png)
