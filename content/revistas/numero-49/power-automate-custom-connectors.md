...
slug: "power-automate-custom-connectors"
magazineSlug: "numero-49"
author: "Alex Rostán"
authorSlug: "alex-rostan"
keywords: ['Power Automate','Power Platform']
image: "../images/power-automate-custom-connectors/image5.png"
---
...
![Imagen 1.- Acceso a conectores personalizados.](../images/power-automate-custom-connectors/image1.png)

Una vez allí iremos a crear un nuevo conector personalizado y creamos
uno desde cero:

![Imagen 2.- Creación de conector personalizado.](../images/power-automate-custom-connectors/image2.png)

Le ponemos un nombre al conector y le damos continuar:

![Imagen 3.- Nombre para el conector personalizado.](../images/power-automate-custom-connectors/image3.png)
...
![Imagen 4.- Configuración general del conector personalizado.](../images/power-automate-custom-connectors/image4.png)
...
web en Azure. Una vez completada esta sección damos en ![](../images/power-automate-custom-connectors/image5.png) y continuamos con la siguiente sección.

En esta sección lo primero que debemos seleccionar es el tipo de
seguridad:

![Imagen 5.- Tipo de autenticación.](../images/power-automate-custom-connectors/image6.png)

Seleccionamos OAuth 2.0 y nos aparecerá la siguiente pantalla:

![Imagen 6.- Parámetros de configuración para Oauth 2.0.](../images/power-automate-custom-connectors/image7.png)
...
![Imagen 7.- Acceso al registro de aplicaciones.](../images/power-automate-custom-connectors/image8.png)

Ya en el detalle de nuestra aplicación obtenemos los datos
correspondientes:

![Imagen 8.- Acceso a la información general del registro de aplicaciones.](../images/power-automate-custom-connectors/image9.png)

Ya cargados los datos pasamos a la definición haciendo clic en ![](../images/power-automate-custom-connectors/image10.png)
...
![Imagen 9.- Nueva acción a agregar.](../images/power-automate-custom-connectors/image11.png)

Debemos cargar el resumen, la descripción y el Identificador de nuestra
acción.

![Imagen 10.- Detalles de la acción.](../images/power-automate-custom-connectors/image12.png)

Luego vamos a crear la solicitud para esa operación.

![Imagen 11.- Creación de la solicitud para la acción.](../images/power-automate-custom-connectors/image13.png)
...
![Imagen 12.- Configuración del Verbo.](../images/power-automate-custom-connectors/image14.png)
