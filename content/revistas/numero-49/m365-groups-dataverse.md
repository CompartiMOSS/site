...
![Imagen 1. Ejemplo de privilegios de los roles de Dataverse.](../images/m365-groups-dataverse/image1.png)
...
![Imagen 2. Niveles de permisos en los roles de Dataverse.](../images/m365-groups-dataverse/image2.png)
...
![Imagen 3. Ejemplo de unidades de negocio.](../images/m365-groups-dataverse/image3.png)
...
![Imagen 4. Cómo crear equipos en Dataverse (panel del entorno).](../images/m365-groups-dataverse/image4.png)

Desde esta sección deberemos crear el equipo:

![Imagen 5. Cómo crear equipos en Dataverse.](../images/m365-groups-dataverse/image5.png)
...
![Imagen 6. Formulario de creación de equipos (AAD Security Group).](../images/m365-groups-dataverse/image6.png)

Una vez que hayamos creado el equipo simplemente deberemos asignarle el
rol o roles de seguridad que le correspondan.

![Imagen 7. Asignación de roles a un equipo tras la creación.](../images/m365-groups-dataverse/image7.png)
...
![Imagen 8. Formulario de creación de equipos (AAD Office Group).](../images/m365-groups-dataverse/image8.png)
