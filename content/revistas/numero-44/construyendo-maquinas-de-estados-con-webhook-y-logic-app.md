...
![Imagen 1.- Máquina Moore.](../images/construyendo-maquinas-de-estados-con-webhook-y-logic-app/image1.png)
...
![Imagen 2.- Proceso a modelar.](../images/construyendo-maquinas-de-estados-con-webhook-y-logic-app/image2.png)
...
![Imagen 3.- Http action.](../images/construyendo-maquinas-de-estados-con-webhook-y-logic-app/image3.png)
...
![Imagen 4.- Trigger Queue Blob Storage.](../images/construyendo-maquinas-de-estados-con-webhook-y-logic-app/image4.png)
...
![Imagen 5.- Acción Until.](../images/construyendo-maquinas-de-estados-con-webhook-y-logic-app/image5.png)
...
![Imagen 6.- Switch Control.](../images/construyendo-maquinas-de-estados-con-webhook-y-logic-app/image6.png)
...
![Imagen 7.- Proceso basado en estados.](../images/construyendo-maquinas-de-estados-con-webhook-y-logic-app/image7.png)
...
![Imagen 8.- Condiciones.](../images/construyendo-maquinas-de-estados-con-webhook-y-logic-app/image8.png)
...
![Imagen 9.- Persistencia en CDS.](../images/construyendo-maquinas-de-estados-con-webhook-y-logic-app/image9.png)
...
![Imagen 10.- Estado Draft, llamando al subproceso.](../images/construyendo-maquinas-de-estados-con-webhook-y-logic-app/image10.png)
...
![Imagen 11.- Http Webhook.](../images/construyendo-maquinas-de-estados-con-webhook-y-logic-app/image11.png)
...
![Imagen 12.- Subprocesos.](../images/construyendo-maquinas-de-estados-con-webhook-y-logic-app/image12.png)
...
![Imagen 13.- Cola de Subproceso.](../images/construyendo-maquinas-de-estados-con-webhook-y-logic-app/image13.png)
...
![Imagen 14.- Control de Callback.](../images/construyendo-maquinas-de-estados-con-webhook-y-logic-app/image14.png)
...
![Imagen 15.- Condición de fin de Flujo.](../images/construyendo-maquinas-de-estados-con-webhook-y-logic-app/image15.png)
...
![Imagen 16.- Flujo Completo.](../images/construyendo-maquinas-de-estados-con-webhook-y-logic-app/image16.png)
...
![Imagen 17.- Ámbitos.](../images/construyendo-maquinas-de-estados-con-webhook-y-logic-app/image17.png)
...
![Imagen 18.- Control de errores.](../images/construyendo-maquinas-de-estados-con-webhook-y-logic-app/image18.png)
...
![Imagen 19.- Qué hacemos con el error.](../images/construyendo-maquinas-de-estados-con-webhook-y-logic-app/image19.png)
...
![Imagen 20.- Arquitectura Global.](../images/construyendo-maquinas-de-estados-con-webhook-y-logic-app/image20.png)
