...
![Imagen 1.- Proceso Lógico.](../images/introducción-al-almacen-de-conocimiento-knowledge-store/image1.png)
...
![Imagen 2.- Estructura JSON.](../images/introducción-al-almacen-de-conocimiento-knowledge-store/image2.png)
...
![Imagen 3.- Importar datos.](../images/introducción-al-almacen-de-conocimiento-knowledge-store/image3.png)

2. Seleccionar Almacenamiento Blob y buscar la cuenta de almacenamiento creada anteriormente.​

![Imagen 4.- Buscar cuenta de almacenamiento.](../images/introducción-al-almacen-de-conocimiento-knowledge-store/image4.png)

3. Seleccionar el contenedor de la cuenta de almacenamiento.​

![Imagen 5.- Contenedor cuenta de almacenamiento.](../images/introducción-al-almacen-de-conocimiento-knowledge-store/image5.png)

4. Dar un nombre al origen de datos.

![Imagen 6.- Nombrar origen de datos.](../images/introducción-al-almacen-de-conocimiento-knowledge-store/image6.png)
...
![Imagen 7.- Adjuntar servicio cognitivo de Azure.](../images/introducción-al-almacen-de-conocimiento-knowledge-store/image7.png)
...
![Imagen 8.- Agregando enriquecimientos.](../images/introducción-al-almacen-de-conocimiento-knowledge-store/image8.png)
...
![Imagen 9.- Selección de conocimientos cognitivos de texto.](../images/introducción-al-almacen-de-conocimiento-knowledge-store/image9.png)
...
![     Imagen 10.- Selección de conocimientos cognitivos de imagen.](../images/introducción-al-almacen-de-conocimiento-knowledge-store/image10.png)
...
![     Imagen 11.- Plantilla Power BI.](../images/introducción-al-almacen-de-conocimiento-knowledge-store/image11.png)
...
![     Imagen 12.- Personalización del índice.](../images/introducción-al-almacen-de-conocimiento-knowledge-store/image12.png)

7. Finalmente se configura la recurrencia de la indización y se termina el proceso dando clic en enviar.​

![     Imagen 13.- Configuración de la recurrencia de indización.](../images/introducción-al-almacen-de-conocimiento-knowledge-store/image13.png)
...
![Imagen 14.- Estado de indización.](../images/introducción-al-almacen-de-conocimiento-knowledge-store/image14.png)
...
![Imagen 15.- Selección de Tablas para consultar.](../images/introducción-al-almacen-de-conocimiento-knowledge-store/image15.png)

Si se quiere ver el contenido de las tablas, se puede usar el explorador de almacenamiento de Azure para tablas.

![Imagen 16.- Explorador de Tablas.](../images/introducción-al-almacen-de-conocimiento-knowledge-store/image16.png)
...
![Imagen 17.- Configuración plantilla Power BI.](../images/introducción-al-almacen-de-conocimiento-knowledge-store/image17.png)

Luego cargamos los datos:

![Imagen 18.- Proceso de Carga de Datos.](../images/introducción-al-almacen-de-conocimiento-knowledge-store/image18.png)
...
![Imagen 19.- Reporte Power BI generado.](../images/introducción-al-almacen-de-conocimiento-knowledge-store/image19.png)
