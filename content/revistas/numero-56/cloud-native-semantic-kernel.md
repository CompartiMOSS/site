...
slug: "cloud-native-semantic-kernel"
magazineSlug: "numero-56"
author: "Rodrigo Liberoff"
authorSlug: "rodrigo-liberoff"
keywords: ['Cloud Native', 'Semantic Kernel', 'Qdrant', 'AI', 'OpenAI']
image: "../images/cloud-native-semantic-kernel/image1a.png"
---
...
![Imagen 1 - Tabla con el estado actual del desarrollo de conectores en Semantic Kernel para las principales bases de datos vectoriales (cuadro amarillo) a mayo de 2023.](../images/cloud-native-semantic-kernel/image1.png)
...
![Imagen 2.- Arquitectura de referencia de la infraestructura 100% «Cloud Native» que montaremos.](../images/cloud-native-semantic-kernel/image2.png)
...
![Imagen 3.- Donde encontrar el ID y la clave de nuestro Azure Log Analytics Workspace en el Portal de Azure.](../images/cloud-native-semantic-kernel/image3.png)

Otra alternativa es usando el Azure CLI:
 
![Imagen 4.- Como obtener el Workspace Id y las claves del Azure Log Analytics Workspace desde Azure CLI para usar al crear un Azure Container Environment.](../images/cloud-native-semantic-kernel/image4.png)
...
![Imagen 5.- Usando el Azure CLI para crear un Azure Container Environment.](../images/cloud-native-semantic-kernel/image5.png)
...
![Imagen 6.- Donde crear aplicaciones dentro de un Azure Container Environment específico.](../images/cloud-native-semantic-kernel/image6.png)

 
![Imagen 7.- Configurando los datos básicos de la Azure Container App para Qdrant.](../images/cloud-native-semantic-kernel/image7.png)
...
![Imagen 8.- Configuración de la imagen de Qdrant para el Azure Container App.](../images/cloud-native-semantic-kernel/image8.png)
...
![Imagen 9.- Configuración del ingreso (ingress)  para el contenedor de Qdrant. Nótese que el acceso es limitado sólo a otras aplicaciones desplegadas dentro del mismo Azure Container Environment, lo cual se hace por temas de seguridad.](../images/cloud-native-semantic-kernel/image9.png)
...
![Imagen 10.- Creación de un Azure File Share para usar como volumen y preservar los datos de Qdrant.](../images/cloud-native-semantic-kernel/image10.png)
...
![Imagen 11.- Donde encontrar las claves del Azure Storage Account, necesarias para crear la vinculación del Azure File Share como volumen en el Azure Container Environment.](../images/cloud-native-semantic-kernel/image11.png)
...
![Imagen 12.- Configuración del Azure Files en el Azure Container Environment.](../images/cloud-native-semantic-kernel/image12.png)
...
![Imagen 13.- Comando del Azure CLI para extraer la configuración del contenedor de Qdrant.](../images/cloud-native-semantic-kernel/image13.png)
...
![Imagen 14 - Comando de Azure CLI para actualizar el contenedor de Qdrant con la configuración modificada para que tenga un volumen vinculado donde dejar de forma permanente sus datos e información que gestiona.](../images/cloud-native-semantic-kernel/image14.png)
...
![Imagen 15 - Opciones de configuración para Qdrant y Semantic Kernel mantenidas y gestionadas dentro de un Azure App Configuration.](../images/cloud-native-semantic-kernel/image15.png)
...
![](../images/cloud-native-semantic-kernel/image1a.png)
...
![](../images/cloud-native-semantic-kernel/image1b.png)
...
![](../images/cloud-native-semantic-kernel/image1c.png)
...
![](../images/cloud-native-semantic-kernel/image1d.png)
...
![](../images/cloud-native-semantic-kernel/image1e.png)
