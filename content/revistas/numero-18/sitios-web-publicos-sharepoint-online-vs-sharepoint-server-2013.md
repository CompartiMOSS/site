...
slug: "sitios-web-publicos-sharepoint-online-vs-sharepoint-server-2013"
...
image: "../images/sitios-web-publicos-sharepoint-online-vs-sharepoint-server-2013/imagen1.png"
---
...
![](../images/sitios-web-publicos-sharepoint-online-vs-sharepoint-server-2013/imagen1.png)
...
![Imagen 1.- Acceso a la galería de WebParts](../images/sitios-web-publicos-sharepoint-online-vs-sharepoint-server-2013/imagen2.png)

Estando en el listado de WebParts, seleccionamos el que necesitamos, lo descargamos y lo guardamos en nuestra máquina:

![Imagen 2.- Selección de la Web Part a descargar.](../images/sitios-web-publicos-sharepoint-online-vs-sharepoint-server-2013/imagen3.png)
...
![](../images/sitios-web-publicos-sharepoint-online-vs-sharepoint-server-2013/imagen4.png)

En esta galería observaremos menos Web Parts.

Vamos a cargar el WebPart que deseamos tener dando clic en "Upload document":

![Imagen 3.- Carga de una Web Part en la galería](../images/sitios-web-publicos-sharepoint-online-vs-sharepoint-server-2013/imagen5.png)

Se busca el Web Part donde lo descargamos anteriormente:

![Imagen 4.- Carga de la Web Part.](../images/sitios-web-publicos-sharepoint-online-vs-sharepoint-server-2013/imagen6.png)

![Imagen 5.- Selección de la WebPart a cargar.](../images/sitios-web-publicos-sharepoint-online-vs-sharepoint-server-2013/imagen7.png)

Verificamos los datos del WebPart y damos clic en "Save".

![Imagen 6.- Detalle de carga de la WebPart en la galería de WebParts](../images/sitios-web-publicos-sharepoint-online-vs-sharepoint-server-2013/imagen8.png)

Ahora lo podremos visualizar en el listado y ya está listo para ser utilizado en nuestra Página Web Pública.

![Imagen 7.- WebPart cargada en la galería.](../images/sitios-web-publicos-sharepoint-online-vs-sharepoint-server-2013/imagen9.png)

![Imagen 8.- Uso de la WebPart en el sitio público](../images/sitios-web-publicos-sharepoint-online-vs-sharepoint-server-2013/imagen10.png)
