...
slug: "exponiendo-datos-binarios-con-bcs"
magazineSlug: "numero-18"
author: "Edin Kapic"
authorSlug: "edin-kapic"
keywords: ['Business Connectivity Services']
image: "../images/exponiendo-datos-binarios-con-bcs/imagen1.png"
...
![Imagen 1.- La base de datos de fotografías en SQL Server](../images/exponiendo-datos-binarios-con-bcs/imagen1.png)
...
![Imagen 2.- A punto de crear un tipo de contenido externo en SharePoint Designer](../images/exponiendo-datos-binarios-con-bcs/imagen2.png)
...
![Imagen 3.- Descubriendo los orígenes de contenido externo](../images/exponiendo-datos-binarios-con-bcs/imagen3.png)
...
![Imagen 4.- Creando las operaciones de acceso a datos externos](../images/exponiendo-datos-binarios-con-bcs/imagen4.png)

Aceptaremos todas las opciones por defecto y tendremos una pantalla como la siguiente:

![Imagen 5.- El tipo de contenido externo listo para ser usadoImagen 5.- El tipo de contenido externo listo para ser usado](../images/exponiendo-datos-binarios-con-bcs/imagen5.png)
...
![Imagen 6.- Vemos los datos de la foto pero sin poder verla.](../images/exponiendo-datos-binarios-con-bcs/imagen6.png)
...
![Imagen 7.- Exportando el modelo BCS desde SharePoint Designer.](../images/exponiendo-datos-binarios-con-bcs/imagen7.png)
...
![Imagen 8.- Dejando espacio para el método de acceso a datos binarios](../images/exponiendo-datos-binarios-con-bcs/imagen8.png)
...
![Imagen 9.- El modelo actualizado está listo](../images/exponiendo-datos-binarios-con-bcs/imagen9.png)
...
![Imagen 10.- Exponiendo los datos binarios a la luz desde la WebPart de Lista de datos empresariales](../images/exponiendo-datos-binarios-con-bcs/imagen10.png)

Ahora tenemos un enlace en cada fila de la lista (que antes no salía) y que dice que cliquemos allí para bajar la foto.

![Imagen 11.- Ya se ve la descarga de la foto](../images/exponiendo-datos-binarios-con-bcs/imagen11.png)

Si lo clicamos veremos que la foto se descarga en toda su gloria binaria.

![Imagen 12.- La satisfacción final de trabajo bien hecho](../images/exponiendo-datos-binarios-con-bcs/imagen12.png)
