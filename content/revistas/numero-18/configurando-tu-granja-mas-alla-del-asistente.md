...
![Imagen 1.- Opción “Specify Values for Templates Parameters…](../images/configurando-tu-granja-mas-alla-asistente/imagen1.png)

… podremos asignar los valores definitivos y luego proceder a la ejecución del mismo.

![Imagen 2.- Valores de los parámetros](../images/configurando-tu-granja-mas-alla-asistente/imagen2.png)

Con lo que conseguiremos las bases de datos con los tamaños adecuados (pero aún vacíos):

![Imagen 3.- Bases de datos definidas](../images/configurando-tu-granja-mas-alla-asistente/imagen3.png)
