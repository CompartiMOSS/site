...
slug: "olvidar-o-no-olvidar-no-olvidar-utiliza-sharepoint-y-simplemente-recuerda"
magazineSlug: "numero-18"
author: "Tomasz Głogosz"
authorSlug: "tomasz-głogosz"
keywords: ['Colaboración','Alertas']
image: "../images/olvidar-o-no-olvidar-no-olvidar-utiliza-sharepoint-y-simplemente-recuerda/imagen3.png"
---
...
![Imagen 1.- Lista de SharePoint simple con temas asignados](../images/olvidar-o-no-olvidar-no-olvidar-utiliza-sharepoint-y-simplemente-recuerda/imagen1.png)
...
![Imagen 2.- Un simple flujo de trabajo creado en SharePoint Designer](../images/olvidar-o-no-olvidar-no-olvidar-utiliza-sharepoint-y-simplemente-recuerda/imagen2.png)
...
![](../images/olvidar-o-no-olvidar-no-olvidar-utiliza-sharepoint-y-simplemente-recuerda/imagen3.png)
...
![](../images/olvidar-o-no-olvidar-no-olvidar-utiliza-sharepoint-y-simplemente-recuerda/imagen4.png)
...
![](../images/olvidar-o-no-olvidar-no-olvidar-utiliza-sharepoint-y-simplemente-recuerda/imagen5.png)
...
![](../images/olvidar-o-no-olvidar-no-olvidar-utiliza-sharepoint-y-simplemente-recuerda/imagen6.png)
...
![](../images/olvidar-o-no-olvidar-no-olvidar-utiliza-sharepoint-y-simplemente-recuerda/imagen7.png)
...
![Imagen 3.- Flujo de trabajo por asuntos creado en Nintex Workflow](../images/olvidar-o-no-olvidar-no-olvidar-utiliza-sharepoint-y-simplemente-recuerda/imagen8.png)
...
![Imagen 4.- Flujo de trabajo por asignación creado en Datapolis WorkBox](../images/olvidar-o-no-olvidar-no-olvidar-utiliza-sharepoint-y-simplemente-recuerda/imagen9.png)
...
![Imagen 5.- Las acciones de Datapolis WorkBox son visibles en la lista de SharePoint](../images/olvidar-o-no-olvidar-no-olvidar-utiliza-sharepoint-y-simplemente-recuerda/imagen10.png)
...
![Imagen 6.- Ventana de contadores de tiempo automáticos en Datapolis WorkBox](../images/olvidar-o-no-olvidar-no-olvidar-utiliza-sharepoint-y-simplemente-recuerda/imagen11.png)
...
![Imagen 7.- Se envían una actividad por correo electrónico en Datapolis WorkBox](../images/olvidar-o-no-olvidar-no-olvidar-utiliza-sharepoint-y-simplemente-recuerda/imagen12.png)
...
![Imagen 8.- Ejemplo de flujo de trabajo creado en Datapolis WorkBox](../images/olvidar-o-no-olvidar-no-olvidar-utiliza-sharepoint-y-simplemente-recuerda/imagen13.png)
