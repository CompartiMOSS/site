...
slug: "paginas-maestras-y-aplicaciones-sharepoint-hosted"
magazineSlug: "numero-20"
author: "Luis Mañez"
authorSlug: "luis-manez"
keywords: ['Aplicaciones','Páginas Maestras']
image: "../images/paginas-maestras-y-aplicaciones-sharepoint-hosted/imagen8.png"
---
...
![Imagen 1.- Arquitectura de una Aplicación SharePoint-Hosted.](../images/paginas-maestras-y-aplicaciones-sharepoint-hosted/imagen1.gif)
...
![Imagen 2.- Galería de Páginas Maestras en una Aplicación SharePoin-Hosted.](../images/paginas-maestras-y-aplicaciones-sharepoint-hosted/imagen2.png)
...
![Imagen 3.- Tema aplicado a un sitio de SharePoint.](../images/paginas-maestras-y-aplicaciones-sharepoint-hosted/imagen3.png)

![Imagen 4.- Tema aplicado a la SharePoint-Hosted App.](../images/paginas-maestras-y-aplicaciones-sharepoint-hosted/imagen4.png)
...
![Imagen 5.- Página de una App usando seattle.master como página maestra.](../images/paginas-maestras-y-aplicaciones-sharepoint-hosted/imagen5.png)
...
![Imagen 6.- Error de redirección al pulsar “Contenidos del sitio”](../images/paginas-maestras-y-aplicaciones-sharepoint-hosted/imagen6.png)
...
![Imagen 7.- Módulo para provisionar la página maestra personalizada.](../images/paginas-maestras-y-aplicaciones-sharepoint-hosted/imagen7.png)

- Editamos el archivo Elements.xml y lo configuramos con el siguiente código:

![](../images/paginas-maestras-y-aplicaciones-sharepoint-hosted/imagen8.png)
