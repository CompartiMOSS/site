...
![Imagen 1.- Power Virtual Agents Stack.](../images/configurar-autenticacion-power-virtual-agent/image1.png)
...
![Imagen 2.- Formulario para configurar la autenticación.](../images/configurar-autenticacion-power-virtual-agent/image2.png)
...
![Imagen 3.- Aplicación de Azure AD a registrar.](../images/configurar-autenticacion-power-virtual-agent/image3.png)
...
![Imagen 4.- Configuración de URL de Redirección.](../images/configurar-autenticacion-power-virtual-agent/image4.png)

![Imagen 5.- Configuración Tokens de acceso.](../images/configurar-autenticacion-power-virtual-agent/image5.png)
...
![Imagen 6.- Configuración de permisos en el Graph.](../images/configurar-autenticacion-power-virtual-agent/image6.png)

- Por último, dirígete a "Certificados y secretos" y crea un nuevo secreto de cliente:

![Imagen 7.- Creación de secretos de cliente.](../images/configurar-autenticacion-power-virtual-agent/image7.png)
...
![Imagen 8.- Copiando el ClientID y ClientSecret para el PVA.](../images/configurar-autenticacion-power-virtual-agent/image8.png)

![Imagen 9.- Configuración del ClientID y ClientSecret en el PVA.](../images/configurar-autenticacion-power-virtual-agent/image9.png)
...
![Imagen 10.- Añadiendo la acción de autenticación en el PVA.](../images/configurar-autenticacion-power-virtual-agent/image10.png)

![Imagen 11.- OneTime Code para logarse en el PVA.](../images/configurar-autenticacion-power-virtual-agent/image11.png)
