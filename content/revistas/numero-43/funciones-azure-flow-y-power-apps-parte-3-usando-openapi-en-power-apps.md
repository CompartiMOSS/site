...
![Imagen 1.- Error en el conector basado en la definición de OpenAPI de la función de Azure.](../images/funciones-azure-flow-y-power-apps-parte-3-usando-openapi-en-power-apps/image1.png)
...
![Imagen 2.- Modificar la definición de OpenAPI. ](../images/funciones-azure-flow-y-power-apps-parte-3-usando-openapi-en-power-apps/image2.png)
...
![Imagen 3.- Conector con la definición de OpenAPI modificada.](../images/funciones-azure-flow-y-power-apps-parte-3-usando-openapi-en-power-apps/image3.png)
...
![Imagen 4.- La aplicación de PowerApps.](../images/funciones-azure-flow-y-power-apps-parte-3-usando-openapi-en-power-apps/image4.png)
...
![Imagen 5.- El conector en la aplicación de PowerApps ](../images/funciones-azure-flow-y-power-apps-parte-3-usando-openapi-en-power-apps/image5.png)
...
![Imagen 6.- La aplicación funcionando .](../images/funciones-azure-flow-y-power-apps-parte-3-usando-openapi-en-power-apps/image6.png)
...
![Imagen 9.- La Función de Azure trabajando con los datos de la aplicación .](../images/funciones-azure-flow-y-power-apps-parte-3-usando-openapi-en-power-apps/image7.png)
