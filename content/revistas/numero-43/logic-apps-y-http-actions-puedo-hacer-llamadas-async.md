...
![Imagen 1.- Standar action Logic App Http.](../images/logic-apps-y-http-actions-puedo-hacer-llamadas-async/image1.png)
...
![Imagen 2.- Polling pattern.](../images/logic-apps-y-http-actions-puedo-hacer-llamadas-async/image2.png)
...
![Imagen 3.- Http 202 accepted.](../images/logic-apps-y-http-actions-puedo-hacer-llamadas-async/image3.png)
...
![Imagen 4.- Polling timer.](../images/logic-apps-y-http-actions-puedo-hacer-llamadas-async/image4.png)
...
![Imagen 5.- Return 200 ok.](../images/logic-apps-y-http-actions-puedo-hacer-llamadas-async/image5.png)
...
![Imagen 6.- Response workflow.](../images/logic-apps-y-http-actions-puedo-hacer-llamadas-async/image6.png)

Este workflow contará de cuatro pasos, que serán los siguientes:

1. Desencadenador por Http:

![Imagen 7.- Http Triger Logic App.](../images/logic-apps-y-http-actions-puedo-hacer-llamadas-async/image7.png)

2. Mapeo de body de entrada, a un JSON entendible por Logic App con "Parse Json":

![Imagen 8.- Parse JSON Logic App.](../images/logic-apps-y-http-actions-puedo-hacer-llamadas-async/image8.png)

3. Delay de 3 minutos, para simular un time out en los procesos que consuman a este proceso.

![Imagen 9.- Timer.](../images/logic-apps-y-http-actions-puedo-hacer-llamadas-async/image9.png)

4. Acción de respuesta que tenga activa el modo Async para poder implementar el patron polling.​

![Imagen 10.- Response – Action.](../images/logic-apps-y-http-actions-puedo-hacer-llamadas-async/image10.png)
...
![Imagen 11.- Async process.](../images/logic-apps-y-http-actions-puedo-hacer-llamadas-async/image11.png)
...
![Imagen 12.- Testing Postman Workflow.](../images/logic-apps-y-http-actions-puedo-hacer-llamadas-async/image12.png)
...
![Imagen 13.- Location Header.](../images/logic-apps-y-http-actions-puedo-hacer-llamadas-async/image13.png)
...
![Imagen 14.- 200 Response.](../images/logic-apps-y-http-actions-puedo-hacer-llamadas-async/image14.png)
...
![Imagen 15.- Request polling workflow.](../images/logic-apps-y-http-actions-puedo-hacer-llamadas-async/image15.png)
...
![Imagen 16.- Http Polling action.](../images/logic-apps-y-http-actions-puedo-hacer-llamadas-async/image16.png)
...
![Imagen 17.- Settings Http Action.](../images/logic-apps-y-http-actions-puedo-hacer-llamadas-async/image17.png)
...
![Imagen 18.- Resultado del polling.](../images/logic-apps-y-http-actions-puedo-hacer-llamadas-async/image18.png)
...
![Imagen 19.-Flujo de seguimiento de pedido.](../images/logic-apps-y-http-actions-puedo-hacer-llamadas-async/image19.png)
...
![Imagen 20.- Métricas skipped action.](../images/logic-apps-y-http-actions-puedo-hacer-llamadas-async/image20.png)
...
![Imagen 21.- Patrón webhook.](../images/logic-apps-y-http-actions-puedo-hacer-llamadas-async/image21.png)
...
![Imagen 22.- Acción de Webhook.](../images/logic-apps-y-http-actions-puedo-hacer-llamadas-async/image22.png)
...
![Imagen 23.- Seguimiento pedido con webhook.](../images/logic-apps-y-http-actions-puedo-hacer-llamadas-async/image23.png)
