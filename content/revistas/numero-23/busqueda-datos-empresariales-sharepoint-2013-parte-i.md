...
slug: "busqueda-datos-empresariales-sharepoint-2013-parte-i"
...
image: "../images/busqueda-datos-empresariales-sharepoint-2013-parte-i/imagen3.png"
---
...
![Imagen 1.- Muestra un gráfico ilustrativo para presentar datos de orígenes externos en SharePoint.](../images/busqueda-datos-empresariales-sharepoint-2013-parte-i/imagen1.png)
...
![Imagen 2.- Muestra del contenido del fichero comprimido del servicio web de proveedores.](../images/busqueda-datos-empresariales-sharepoint-2013-parte-i/imagen2.png)
...
![](../images/busqueda-datos-empresariales-sharepoint-2013-parte-i/imagen3.png)
...
![Imagen 3.- Muestra la ventana para crear un nuevo directorio virtual en IIS.](../images/busqueda-datos-empresariales-sharepoint-2013-parte-i/imagen3.1.png)
...
![Imagen 4.- Muestra el servicio web de proveedores.](../images/busqueda-datos-empresariales-sharepoint-2013-parte-i/imagen4.png)
...
![Imagen 4.- Muestra el resultado de la búsqueda realizada de SharePoint 2013.](../images/busqueda-datos-empresariales-sharepoint-2013-parte-i/imagen4.1.png)
...
![Imagen 5.- Muestra la página de las aplicaciones del servicio en el la administración central.](../images/busqueda-datos-empresariales-sharepoint-2013-parte-i/imagen5.png)

- Creamos una nueva aplicación destino. Seleccionamos el botón de nuevo (New) en la cinta de opciones.

![Imagen 6.- Muestra la cinta de opciones de la aplicación de servicios de almacén seguro (New).](../images/busqueda-datos-empresariales-sharepoint-2013-parte-i/imagen6.png)
...
![Imagen 7.- Muestra el primer formulario para crear una aplicación de destino.](../images/busqueda-datos-empresariales-sharepoint-2013-parte-i/imagen7.png)

Marcamos el tipo de campo de nombre de usuario de Windows (Windows User Name) y pulsamos sobre el botón de siguiente (Next).

![Imagen 8.- Muestra el segundo formulario para crear una aplicación de destino.](../images/busqueda-datos-empresariales-sharepoint-2013-parte-i/imagen8.png)
...
![Imagen 9.- Muestra el formulario para asignar las credenciales.](../images/busqueda-datos-empresariales-sharepoint-2013-parte-i/imagen9.png)
...
![Imagen 10.- Muestra la cinta de opciones de la aplicación de servicios de almacén seguro (Set).](../images/busqueda-datos-empresariales-sharepoint-2013-parte-i/imagen10.png)
...
![Imagen 11.- Muestra el formulario para asignar las credenciales en el almacén seguro.](../images/busqueda-datos-empresariales-sharepoint-2013-parte-i/imagen11.png)
...
![Imagen 12.- Muestra el resultado de la búsqueda realizada de Designer.](../images/busqueda-datos-empresariales-sharepoint-2013-parte-i/imagen12.png)
...
![Imagen 13.- Muestra el formulario principal de Microsoft SharePoint Designer 2013.](../images/busqueda-datos-empresariales-sharepoint-2013-parte-i/imagen13.png)
...
![Imagen 14.- Muestra la cinta de opciones del objeto de tipos de contenido externo.](../images/busqueda-datos-empresariales-sharepoint-2013-parte-i/imagen14.png)
...
![Imagen 15.- Muestra el formulario del nuevo tipo de contenido externo.](../images/busqueda-datos-empresariales-sharepoint-2013-parte-i/imagen15.png)
...
![Imagen 16.- Muestra el formulario para crear una nueva conexión de datos externo.](../images/busqueda-datos-empresariales-sharepoint-2013-parte-i/imagen16.png)
...
![Imagen 17.- Muestra las operaciones de los métodos web (New Read List Operation).](../images/busqueda-datos-empresariales-sharepoint-2013-parte-i/imagen17.png)
...
![Imagen 18.- Muestra el formulario de propiedades de las operaciones de lectura de la lista.](../images/busqueda-datos-empresariales-sharepoint-2013-parte-i/imagen18.png)
...
![Imagen 19.- Muestra el formulario de parámetros de entradas en las operaciones de lectura de la lista.](../images/busqueda-datos-empresariales-sharepoint-2013-parte-i/imagen19.png)
...
![Imagen 20.- Muestra el formulario de parámetros de retorno en las operaciones de lectura de la lista.](../images/busqueda-datos-empresariales-sharepoint-2013-parte-i/imagen20.png)
...
![Imagen 21.- Muestra las operaciones de los métodos web (New Read Item Operation).](../images/busqueda-datos-empresariales-sharepoint-2013-parte-i/imagen21.png)

En la primera ventana del formulario (Operation Properties) dejamos los valores por defecto y pulsamos el botón de siguiente (Next).

![Imagen 22.- Muestra el formulario de propiedades de las operaciones de lectura de la lista.](../images/busqueda-datos-empresariales-sharepoint-2013-parte-i/imagen22.png)
...
![Imagen 23.- Muestra el formulario de parámetros de entradas en las operaciones de lectura de elemento.](../images/busqueda-datos-empresariales-sharepoint-2013-parte-i/imagen23.png)
...
![Imagen 24.- Muestra el formulario de parámetros de retorno en las operaciones de lectura de un elemento.](../images/busqueda-datos-empresariales-sharepoint-2013-parte-i/imagen24.png)
...
![Imagen 25.- Muestra la opciones de guardado del SharePoint Designer.](../images/busqueda-datos-empresariales-sharepoint-2013-parte-i/imagen25.png)
...
![Imagen 26.- Muestra el resultado de la búsqueda realizada de SharePoint 2013.](../images/busqueda-datos-empresariales-sharepoint-2013-parte-i/imagen26.png)
...
![Imagen 27.- Muestra la página de las aplicaciones del servicio en el la administración central.](../images/busqueda-datos-empresariales-sharepoint-2013-parte-i/imagen27.png)
...
![Imagen 28.- Muestra los tipos de contenidos externo.](../images/busqueda-datos-empresariales-sharepoint-2013-parte-i/imagen28.png)
...
![Imagen 29.- Muestra el formulario de configuración del origen de datos.](../images/busqueda-datos-empresariales-sharepoint-2013-parte-i/imagen29.png)
...
![Imagen 30.- Muestra el formulario de tipo de contenido externo de proveedores.](../images/busqueda-datos-empresariales-sharepoint-2013-parte-i/imagen30.png)
...
![Imagen 31.- Muestra el formulario de seguridad de tipo de contenido externo de proveedores.](../images/busqueda-datos-empresariales-sharepoint-2013-parte-i/imagen31.png)
