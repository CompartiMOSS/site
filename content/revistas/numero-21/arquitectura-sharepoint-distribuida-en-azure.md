...
slug: "arquitectura-sharepoint-distribuida-en-azure"
magazineSlug: "numero-21"
author: "Fabian Calvo"
authorSlug: "fabian-calvo"
keywords: ['Arquitectura','Azure','Infrastructura']
image: "../images/arquitectura-sharepoint-distribuida-en-azure/imagen2.png"
---
...
![Imagen 1.- Diagrama de Arquitectura.](../images/arquitectura-sharepoint-distribuida-en-azure/imagen1.png)
...
- Pulsar sobre el ![](../images/arquitectura-sharepoint-distribuida-en-azure/imagen2.png) de la esquina inferior derecha. Seleccionar network services –&gt; Virtual network à Custom create. Darle un nombre (en nuestro caso Suscripcion1) y seleccionar un área geográfica (a España le corresponde North Europe).
...
![Imagen 2.- Panel de Creación.](../images/arquitectura-sharepoint-distribuida-en-azure/imagen3.png)
...
![Imagen 3.- Galerías de Máquinas Virtuales.](../images/arquitectura-sharepoint-distribuida-en-azure/imagen4.png)
...
![Imagen 4.- Registro de DNS.](../images/arquitectura-sharepoint-distribuida-en-azure/imagen5.png)
...
5. Una vez realizado el paso anterior, podemos ir a la red creada y pulsar en la página de configuración. Bajo el apartado conectividad sitio a sitio (site-to-site connectivity) seleccionar conectar a una red local, y seleccionar la red que configuramos anteriormente (VNET2 en la subscripción 1, VNET1 en la subscripción 2). ![Imagen 5.- Configuración de las conexiones.](../images/arquitectura-sharepoint-distribuida-en-azure/imagen6.png)
6. En el siguiente apartado, denominado espacios de direcciones de red virtual (virtual network address spaces) pulsar sobre añadir subred de Gateway, y pulsar salvar al final de la página.  ![Imagen 6.- Sección de espacios de redes virtuales.](../images/arquitectura-sharepoint-distribuida-en-azure/imagen7.png)
...
![Imagen 7.- Redes virtuales creadas.](../images/arquitectura-sharepoint-distribuida-en-azure/imagen8.png)
