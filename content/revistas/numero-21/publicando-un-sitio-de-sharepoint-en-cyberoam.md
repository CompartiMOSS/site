...
![Imagen 1.- Acceso a la Administración Central de SharePoint 2013.](../images/publicando-un-sitio-de-sharepoint-en-cyberoam/imagen1.png)

- Tenemos nuestra lista de Web applications:

![Imagen 2.- Listado de Aplicaciones Web.](../images/publicando-un-sitio-de-sharepoint-en-cyberoam/imagen2.png)

- Clicamos nuestra Web applications y luego en Extend:

![Imagen 3.- Extensión de una aplicación web existente.](../images/publicando-un-sitio-de-sharepoint-en-cyberoam/imagen3.png)
...
![Imagen 4.- Configuración de la aplicación web extendida.](../images/publicando-un-sitio-de-sharepoint-en-cyberoam/imagen4.png)

A continuación se muestran el resto de configuraciones necesarias al extender la aplicación web:

​![Imagen 5.- Resto de configuraciones necesarias en la extensión de la aplicación web.](../images/publicando-un-sitio-de-sharepoint-en-cyberoam/imagen5.png)
...
![Imagen 6.- Configuración de Authentication providers.](../images/publicando-un-sitio-de-sharepoint-en-cyberoam/imagen6.png)

Si luego deseamos modificar algo podremos venir aquí y seleccionar la zona que deseamos modificar.

![Imagen 7.- Authentication providers.](../images/publicando-un-sitio-de-sharepoint-en-cyberoam/imagen7.png)
...
![Imagen 8.- Sitios en IIS.](../images/publicando-un-sitio-de-sharepoint-en-cyberoam/imagen8.png)
...
![Imagen 9.- Configuración del firewall.](../images/publicando-un-sitio-de-sharepoint-en-cyberoam/imagen9.png)
