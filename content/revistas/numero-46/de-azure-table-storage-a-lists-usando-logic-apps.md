...
![**Imagen 1.- Azure Storage Explorer.**](../images/de-azure-table-storage-a-lists-usando-logic-apps/image2.png)
...
![**Imagen 2.- Creación de una Lista de Microsoft Lists en Microsoft Teams.**](../images/de-azure-table-storage-a-lists-usando-logic-apps/image3.png)
...
![**Imagen 3.- Añadiendo una columna a la lista.**](../images/de-azure-table-storage-a-lists-usando-logic-apps/image4.png)
...
![**Imagen 4.- Creación de la Logic App.**](../images/de-azure-table-storage-a-lists-usando-logic-apps/image5.png)
...
![**Imagen 5.- Configuración de la Logic App a crear.**](../images/de-azure-table-storage-a-lists-usando-logic-apps/image6.png)

Una vez creada la Logic app, podréis comenzar con su configuración
utilizando la opción 'Logic app designer'.

![**Imagen 6.- Accediendo al Logic app designer.**](../images/de-azure-table-storage-a-lists-usando-logic-apps/image7.png)
...
![**Imagen 7.- Creación de la Logic App desde cero.**](../images/de-azure-table-storage-a-lists-usando-logic-apps/image8.png)
...
![**Imagen 8.- Disparador de la Logic App.**](../images/de-azure-table-storage-a-lists-usando-logic-apps/image9.png)

En mi caso, lo configuré para ejecutarse todos los días a las 7 a.m.

![**Imagen 9.- Configuración del disparador.**](../images/de-azure-table-storage-a-lists-usando-logic-apps/image10.png)
...
![**Imagen 10.- Variables para la Logic App.**](../images/de-azure-table-storage-a-lists-usando-logic-apps/image11.png)

Y las inicializaremos de la siguiente forma:

![**Imagen 11.- Inicialización de las Variables.**](../images/de-azure-table-storage-a-lists-usando-logic-apps/image12.png)
...
![**Imagen 12.- Bloque "Scope" (Ámbito).**](../images/de-azure-table-storage-a-lists-usando-logic-apps/image13.png)
...
![**Imagen 13.- Acción Get entities.**](../images/de-azure-table-storage-a-lists-usando-logic-apps/image14.png)
...
![**Imagen 14.- Selección de la tabla con los registros a extraer.**](../images/de-azure-table-storage-a-lists-usando-logic-apps/image15.png)
...
![**Imagen 15.- Indicando filtros en la consulta a la tabla.**](../images/de-azure-table-storage-a-lists-usando-logic-apps/image16.png)
...
![**Imagen 16.- Acción de parseo de JSON.**](../images/de-azure-table-storage-a-lists-usando-logic-apps/image17.png)
...
![**Imagen 17.- JSON a configurar.**](../images/de-azure-table-storage-a-lists-usando-logic-apps/image18.png)

Así, la acción quedará similar a esta:

![**Imagen 18.- Acción configurada.**](../images/de-azure-table-storage-a-lists-usando-logic-apps/image19.png)
...
![**Imagen 19.- Configuración de nuevo parseo.**](../images/de-azure-table-storage-a-lists-usando-logic-apps/image20.png)
...
![**Imagen 20.- Obtención de los elementos de la lista.**](../images/de-azure-table-storage-a-lists-usando-logic-apps/image21.png)
...
![**Imagen 21.- Configuración de la acción de Get items.**](../images/de-azure-table-storage-a-lists-usando-logic-apps/image22.png)
...
![**Imagen 22.- Establecer variable.**](../images/de-azure-table-storage-a-lists-usando-logic-apps/image23.png)

Seleccionamos nuestra variable y le asignamos el valor del body de la
consulta anterior (List of ítems)

![**Imagen 23.- Inicialización de variable.**](../images/de-azure-table-storage-a-lists-usando-logic-apps/image24.png)
...
![**Imagen 24.- Nuevo parseo.**](../images/de-azure-table-storage-a-lists-usando-logic-apps/image25.png)
...
![**Imagen 25.- Acción compose.**](../images/de-azure-table-storage-a-lists-usando-logic-apps/image26.png)

Quedando la operación de la siguiente forma:

![**Imagen 26.- Configuración de compose.**](../images/de-azure-table-storage-a-lists-usando-logic-apps/image27.png)
...
![**Imagen 27.- Condición.**](../images/de-azure-table-storage-a-lists-usando-logic-apps/image28.png)
...
![**Imagen 28.- Acción de creación de un elemento de lista.**](../images/de-azure-table-storage-a-lists-usando-logic-apps/image29.png)
...
![**Imagen 29.- Configuración de la acción de creación de elemento de lista.**](../images/de-azure-table-storage-a-lists-usando-logic-apps/image30.png)
...
![**Imagen 30.- Acción de enviar e-mail.**](../images/de-azure-table-storage-a-lists-usando-logic-apps/image31.png)

Configuraremos la acción con el texto que deseemos para que quede con un
aspecto similar al siguiente:

![**Imagen 31.- Configuración de la acción de enviar e-mail.**](../images/de-azure-table-storage-a-lists-usando-logic-apps/image32.png)
...
![**Imagen 32.- Ámbito Catch.**](../images/de-azure-table-storage-a-lists-usando-logic-apps/image33.png)
...
![**Imagen 33.- Probando la Logic App.**](../images/de-azure-table-storage-a-lists-usando-logic-apps/image34.png)

Una vez pulsado, veremos cómo se ejecuta el proceso:

![**Imagen 34.- Ejecución de la Logic App.**](../images/de-azure-table-storage-a-lists-usando-logic-apps/image35.png)
...
![**Imagen 35.- Carga de los registros en la lista de Microsoft Lists.**](../images/de-azure-table-storage-a-lists-usando-logic-apps/image36.png)
