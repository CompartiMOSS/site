...
![**Imagen 1.- Añadiendo Power Virtual Agents en Microsoft Teams.**](../images/power_virtual_agents_microsoft_teams/image1.png)

Una vez agregada a nuestras Apps, vamos a la pestaña de Chatbots y
creamos uno nuevo haciendo clic en "New chatbot":

![**Imagen 2.- Creando un primer chatbot.**](../images/power_virtual_agents_microsoft_teams/image2.png)
...
![**Imagen 3.- Seleccionado el Team al que vamos a añadir el chatbot.**](../images/power_virtual_agents_microsoft_teams/image3.png)

Nos aparecerá la siguiente pantalla donde debemos esperar a que todo
quede listo:

![**Imagen 4.- Pantalla de transición a la creación del Chatbot.**](../images/power_virtual_agents_microsoft_teams/image4.png)
...
![**Imagen 5.- Parámetros iniciales de creación del chatbot.**](../images/power_virtual_agents_microsoft_teams/image5.png)

![**Imagen 6.- Pantalla de transición para la creación del chatbot.**](../images/power_virtual_agents_microsoft_teams/image6.png)

Una vez finalizado estaremos en la siguiente pantalla listos para
comenzar a trabajar con el Bot

![**Imagen 7.- Diseñador del Chatbot en Microsoft Teams.**](../images/power_virtual_agents_microsoft_teams/image7.png)

Ahora debemos agregarle nuestras preguntas frecuentes, vamos a "Go to
topics"

![**Imagen 8.- Acceso a la creación de temas (topics) para el Chatbot.**](../images/power_virtual_agents_microsoft_teams/image8.png)

En la siguiente pantalla debemos ir a "Suggested" y luego a Get started:

![**Imagen 9.- Sección Suggested en la configuración de temas para el chatbot.**](../images/power_virtual_agents_microsoft_teams/image9.png)
...
![**Imagen 10.- Configuración del origen de información para los temas sugeridos.**](../images/power_virtual_agents_microsoft_teams/image10.png)
...
![**Imagen 11.- Selección de los temas sugeridos a utilizar.**](../images/power_virtual_agents_microsoft_teams/image11.png)

Una vez agregada los topics debemos habilitarla "turn on"

![**Imagen 12.- Habilitando temas.**](../images/power_virtual_agents_microsoft_teams/image12.png)
...
![**Imagen 13.- Probando el chatbot.**](../images/power_virtual_agents_microsoft_teams/image13.png)

Por último, debemos publicarlo para que los demás integrantes del grupo
de teams seleccionado al inicio lo puedan utilizar

![**Imagen 14.- Publicando el chatbot.**](../images/power_virtual_agents_microsoft_teams/image14.png)

Vamos a publish:

![**Imagen 15.- Acción de publicar el chatbot.**](../images/power_virtual_agents_microsoft_teams/image15.png)

Confirmamos la publicación del chatbot

![**Imagen 16.- Confirmación de publicación del chatbot.**](../images/power_virtual_agents_microsoft_teams/image16.png)

Luego también podemos agregarlo como una app en nuestro Teams

![**Imagen 17.- Agregando el chatbot como una App de Teams.**](../images/power_virtual_agents_microsoft_teams/image17.png)

![**Imagen 18.- Añadiendo el chatbot como una App.**](../images/power_virtual_agents_microsoft_teams/image18.png)
