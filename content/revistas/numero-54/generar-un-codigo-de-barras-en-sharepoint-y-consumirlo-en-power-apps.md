...
slug: "generar-un-codigo-de-barras-en-sharepoint-y-consumirlo-en-power-apps"
...
image: "../images/generar-un-codigo-de-barras-en-sharepoint-y-consumirlo-en-power-apps/image11.png"
---
...
![Imagen 1.- Feature de Site Policy.](../images/generar-un-codigo-de-barras-en-sharepoint-y-consumirlo-en-power-apps/image1.png)
...
![Imagen 2.- Opción "Information management policy settigns" en una biblioteca de documentos.](../images/generar-un-codigo-de-barras-en-sharepoint-y-consumirlo-en-power-apps/image2.png)
...
![Imagen 3.- Lista creada.](../images/generar-un-codigo-de-barras-en-sharepoint-y-consumirlo-en-power-apps/image3.png)
...
![Imagen 4.- Habilitando los códigos de barras.](../images/generar-un-codigo-de-barras-en-sharepoint-y-consumirlo-en-power-apps/image4.png)
...
![Imagen 5.- Campos añadidos a la lista al configurar los códigos de barras.](../images/generar-un-codigo-de-barras-en-sharepoint-y-consumirlo-en-power-apps/image5.png)

Así, si creamos un nuevo elemento, podréis ver que se rellenan
automáticamente estos campos:

![Imagen 6.- Ejemplos de código de barras y valor generado.](../images/generar-un-codigo-de-barras-en-sharepoint-y-consumirlo-en-power-apps/image6.png)
...
![Imagen 7.- Código de barras generado.](../images/generar-un-codigo-de-barras-en-sharepoint-y-consumirlo-en-power-apps/image7.png)
...
![Imagen 8.- Creando la Power App.](../images/generar-un-codigo-de-barras-en-sharepoint-y-consumirlo-en-power-apps/image8.png)
...
![Imagen 9.- Añadiendo el origen de datos a la Power App.](../images/generar-un-codigo-de-barras-en-sharepoint-y-consumirlo-en-power-apps/image9.png)
...
![Imagen 10.- Creando la pantalla para dar de alta elementos.](../images/generar-un-codigo-de-barras-en-sharepoint-y-consumirlo-en-power-apps/image10.png)

En esta pantalla, vamos a modificar la propiedad *DataSource* del
*EditForm* para que sea nuestra lista **Almacén**:

![](../images/generar-un-codigo-de-barras-en-sharepoint-y-consumirlo-en-power-apps/image11.png)
...
![Imagen 11.- Pantalla configurada con la lista.](../images/generar-un-codigo-de-barras-en-sharepoint-y-consumirlo-en-power-apps/image12.png)
...
![](../images/generar-un-codigo-de-barras-en-sharepoint-y-consumirlo-en-power-apps/image13.png)
...
![](../images/generar-un-codigo-de-barras-en-sharepoint-y-consumirlo-en-power-apps/image14.png)
...
![Imagen 12.- Visualizando el Barcode y Barcode Value en la Power App.](../images/generar-un-codigo-de-barras-en-sharepoint-y-consumirlo-en-power-apps/image15.png)
...
![](../images/generar-un-codigo-de-barras-en-sharepoint-y-consumirlo-en-power-apps/image16.png)

Ahora ya podréis observar cómo el código de barras se muestra
correctamente en nuestra app:

![Imagen 13.- Visualizando el Barcode y Barcode Value en la Power App.](../images/generar-un-codigo-de-barras-en-sharepoint-y-consumirlo-en-power-apps/image17.png)
...
![](../images/generar-un-codigo-de-barras-en-sharepoint-y-consumirlo-en-power-apps/image18.png)
...
![Imagen 14.- Añadiendo la funcionalidad de Barcode scanner.](../images/generar-un-codigo-de-barras-en-sharepoint-y-consumirlo-en-power-apps/image19.png)
...
![Imagen 15.- Botón Scan añadido.](../images/generar-un-codigo-de-barras-en-sharepoint-y-consumirlo-en-power-apps/image20.png)
...
![Imagen 16.- Mensaje que se muestra al visualizar el componente en el navegador.](../images/generar-un-codigo-de-barras-en-sharepoint-y-consumirlo-en-power-apps/image21.png)
...
![](../images/generar-un-codigo-de-barras-en-sharepoint-y-consumirlo-en-power-apps/image22.png)
...
![](../images/generar-un-codigo-de-barras-en-sharepoint-y-consumirlo-en-power-apps/image23.png)
...
![Imagen 17.- Visualizando el Barcode y Barcode Value en la Power App.](../images/generar-un-codigo-de-barras-en-sharepoint-y-consumirlo-en-power-apps/image24.png)
