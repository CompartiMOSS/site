...
![Imagen .- Flujo que se ejecuta a partir de una petición HTTP.](../images/hacking-power-platform/image1.png)
...
![Imagen .- Flujo que se ejecuta desde un chatbot de Power Virtual Agents.](../images/hacking-power-platform/image2.png)

El chatbot podría disparar el flujo cuando se introducen algunas
palabras clave, tal y como mostramos seguidamente:

![Imagen .- Editor de \"Topics\" en Power Virtual Agents.](../images/hacking-power-platform/image3.png)

Finalmente, este flujo se podría publicar en uno o más canales, como
Teams, Facebook, Slack, o un en un sitio web:

![Imagen .- Canales de publicación de chatbots de Power Virtual Agents.](../images/hacking-power-platform/image4.png)
...
![Imagen .- Sitio web de demo donde se ha publicado el chatbot de Power Virtual Agents.](../images/hacking-power-platform/image5.png)
...
![Imagen .- Botón de Power Automate en un informe de Power BI.](../images/hacking-power-platform/image6.png)

El flujo es muy similar a lo que hemos visto en los casos anteriores,
donde únicamente cambia el disparador del flujo.

![Imagen .- Flujo de Power Automate que se ejecuta desde un botón de Power BI.](../images/hacking-power-platform/image7.png)
