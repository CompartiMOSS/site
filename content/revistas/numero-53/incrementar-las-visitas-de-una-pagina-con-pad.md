...
slug: "incrementar-las-visitas-de-una-pagina-con-pad"
...
image: "../images/incrementar-las-visitas-de-una-pagina-con-pad/image22.png"
---
...
![Imagen 1.- VM en la que instalar Power Automate Desktop.](../images/incrementar-las-visitas-de-una-pagina-con-pad/image1.png)
...
![Imagen 2.- IP pública dinámica asignada a la VM.](../images/incrementar-las-visitas-de-una-pagina-con-pad/image2.png)
...
![Imagen 3.- Configuración del cierre de sesión en la VM.](../images/incrementar-las-visitas-de-una-pagina-con-pad/image3.png)
...
![Imagen 4.- Acceso a la descarga del cliente de Power Automate Desktop.](../images/incrementar-las-visitas-de-una-pagina-con-pad/image4.png)

Una vez descargado, procedemos a su instalación en la máquina virtual:

![Imagen 5.- Instalación del cliente de Power Automate Desktop.](../images/incrementar-las-visitas-de-una-pagina-con-pad/image5.png)
...
![Imagen 6.- Selección de la versión de Power Automate Desktop.](../images/incrementar-las-visitas-de-una-pagina-con-pad/image6.png)

![Imagen 7.- Versión trial Power Automate Desktop.](../images/incrementar-las-visitas-de-una-pagina-con-pad/image7.png)

Y veremos el mensaje indicando que se ha activado la versión de prueba.

![Imagen 8.- Mensaje de versión trial de Power Automate Desktop activada.](../images/incrementar-las-visitas-de-una-pagina-con-pad/image8.png)
...
![Imagen 9.- Extensión de Power Automate para Edge que se ha instalado.](../images/incrementar-las-visitas-de-una-pagina-con-pad/image9.png)
...
![Imagen 10.- Creación de un Gateway local.](../images/incrementar-las-visitas-de-una-pagina-con-pad/image10.png)
...
![Imagen 11.- E-Mail a utilizar para Gateway local.](../images/incrementar-las-visitas-de-una-pagina-con-pad/image11.png)

Y seleccionamos la opción "*Register a new gateway on this computer*"
para que quede asociado a nuestra VM.

![Imagen 12.- Registro del Gateway en la VM.](../images/incrementar-las-visitas-de-una-pagina-con-pad/image12.png)

Ahora, nos pedirá establecer un nombre para nuestro gateway y una clave
de recuperación:

![Imagen 13.- Configuraciones del Gateway.](../images/incrementar-las-visitas-de-una-pagina-con-pad/image13.png)

Una vez creado, recibiremos el mensaje de que nuestro gateway está
correctamente instalado en el equipo:

![Imagen 14.- Mensaje de confirmación de Gateway instalado y configurado.](../images/incrementar-las-visitas-de-una-pagina-con-pad/image14.png)
...
![Imagen 15.- Comprobación de disponibilidad del Gateway en el Portal de Administración de Power Automate .](../images/incrementar-las-visitas-de-una-pagina-con-pad/image15.png)
...
![Imagen 16.- Desasociando la interfaz de red.](../images/incrementar-las-visitas-de-una-pagina-con-pad/image16.png)

B.  Asociar la interfaz de red:

![Imagen 17.- Asociando la interfaz de red.](../images/incrementar-las-visitas-de-una-pagina-con-pad/image17.png)
...
![Imagen 18.- Acceso a Azure Bastion.](../images/incrementar-las-visitas-de-una-pagina-con-pad/image18.png)
...
![Imagen 19.- Acceso a la creación de una instancia de Azure Bastion.](../images/incrementar-las-visitas-de-una-pagina-con-pad/image19.png)

Seleccionaremos "**Crear una instancia de Azure Bastión**"

![Imagen 20.- Creando una instancia de Azure Bastion.](../images/incrementar-las-visitas-de-una-pagina-con-pad/image20.png)

Tras un rato de espera (5-6 minutos), nos solicitará un usuario y
contraseña para el acceso a nuestra VM.

![Imagen 20.- Usuario y contraseña para el acceso a la VM.](../images/incrementar-las-visitas-de-una-pagina-con-pad/image21.png)
...
2)  Abrimos la aplicación de Power Automate for Desktop y pulsamos en
    ...
    ![](../images/incrementar-las-visitas-de-una-pagina-con-pad/image22.png)
...
![Imagen 21.- Estableciendo una variable en Power Automate Desktop.](../images/incrementar-las-visitas-de-una-pagina-con-pad/image23.png)
...
![](../images/incrementar-las-visitas-de-una-pagina-con-pad/image24.png)
...
![Imagen 22.- Configuración de la acción "Launch new Microsoft Edge".](../images/incrementar-las-visitas-de-una-pagina-con-pad/image25.png)
...
![Imagen 23.- Delay para la carga de la página.](../images/incrementar-las-visitas-de-una-pagina-con-pad/image26.png)
...
![Imagen 24.- Configurando la acción "Click link on web page".](../images/incrementar-las-visitas-de-una-pagina-con-pad/image27.png)

![Imagen 25.- Acción emulada](../images/incrementar-las-visitas-de-una-pagina-con-pad/image28.png)

Una vez seleccionado, la acción quedará configurada de la siguiente
forma:

![Imagen 26.- Configuración final de la acción.](../images/incrementar-las-visitas-de-una-pagina-con-pad/image29.png)

Que en nuestro flujo se mostrará de la siguiente forma:

![](../images/incrementar-las-visitas-de-una-pagina-con-pad/image30.png)
...
![Imagen 27.- Acceso a UI elements desde la opción view.](../images/incrementar-las-visitas-de-una-pagina-con-pad/image31.png)
...
![Imagen 27.- Listado de elementos configurados.](../images/incrementar-las-visitas-de-una-pagina-con-pad/image32.png)
...
![Imagen 28.- Visualización del Div seleccionado.](../images/incrementar-las-visitas-de-una-pagina-con-pad/image33.png)
...
![](../images/incrementar-las-visitas-de-una-pagina-con-pad/image34.png)
...
![](../images/incrementar-las-visitas-de-una-pagina-con-pad/image35.png)
...
![Imagen 29.- Acción "Go to web page".](../images/incrementar-las-visitas-de-una-pagina-con-pad/image36.png)

11) Volvemos a poner un pequeño retraso de 5 segundos para que se
    termine de cargar bien la página.

![](../images/incrementar-las-visitas-de-una-pagina-con-pad/image37.png)
...
![](../images/incrementar-las-visitas-de-una-pagina-con-pad/image38.png)
...
![](../images/incrementar-las-visitas-de-una-pagina-con-pad/image39.png)
...
![](../images/incrementar-las-visitas-de-una-pagina-con-pad/image40.png)

15) Ahora deberemos pulsar el botón "*Ok*", por lo que volveremos a
    utilizar la acción "**Click link on web page**" en el elemento
    correspondiente.

![](../images/incrementar-las-visitas-de-una-pagina-con-pad/image41.png)
...
![](../images/incrementar-las-visitas-de-una-pagina-con-pad/image42.png)
...
![](../images/incrementar-las-visitas-de-una-pagina-con-pad/image43.png)
...
![Imagen 30.- Acción "Extract data from web page".](../images/incrementar-las-visitas-de-una-pagina-con-pad/image44.png)

![Imagen 31.- Elemento a seleccionar.](../images/incrementar-las-visitas-de-una-pagina-con-pad/image45.png)
...
![Imagen 32.- Acción "Get current date and time".](../images/incrementar-las-visitas-de-una-pagina-con-pad/image46.png)
...
![Imagen 33.- Acción "Write text to file".](../images/incrementar-las-visitas-de-una-pagina-con-pad/image47.png)
...
![Imagen 34.- Acción "Close web browser".](../images/incrementar-las-visitas-de-una-pagina-con-pad/image48.png)
...
![Imagen 35.- Acción "Run application".](../images/incrementar-las-visitas-de-una-pagina-con-pad/image49.png)
...
![Imagen 36.- Configurando la extension de Power Automate Desktop para Edge.](../images/incrementar-las-visitas-de-una-pagina-con-pad/image50.png)
...
![Imagen 37.- Acción "Launch new Microsoft Edge".](../images/incrementar-las-visitas-de-una-pagina-con-pad/image51.png)
...
![](../images/incrementar-las-visitas-de-una-pagina-con-pad/image52.png)
...
![](../images/incrementar-las-visitas-de-una-pagina-con-pad/image53.png)
...
![](../images/incrementar-las-visitas-de-una-pagina-con-pad/image54.png)
...
![Imagen 39.- Acción "Run a Flow built with Power Automate for desktop".](../images/incrementar-las-visitas-de-una-pagina-con-pad/image55.png)
...
![Imagen 40.- Opción "Unattended" configurada.](../images/incrementar-las-visitas-de-una-pagina-con-pad/image56.png)

Lo ejecutamos para probarlo:

![Imagen 41.- Probando el Flow.](../images/incrementar-las-visitas-de-una-pagina-con-pad/image57.png)
...
![Imagen 42.- Ejecución errónea del flujo y mensaje mostrado.](../images/incrementar-las-visitas-de-una-pagina-con-pad/image58.png)
...
![Imagen 43.- Comprobación del funcionamiento del Flujo en Google Analytics.](../images/incrementar-las-visitas-de-una-pagina-con-pad/image59.png)
...
![Imagen 44.- Fichero en el que se registran las distintas IPs.](../images/incrementar-las-visitas-de-una-pagina-con-pad/image60.png)
