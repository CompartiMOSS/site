...
![Imagen 1.- Añadiendo un nuevo alias a un buzón existente desde la Administración de Exchange Online.](../images/enviar-email-con-alias/image1.png)
...
![Imagen 2.- Añadiendo un nuevo alias a un buzón existente desde la Administración de Microsoft 365.](../images/enviar-email-con-alias/image2.png)
...
![Imagen 3- Configuración de un alias de correo desde el centro de administración de Exchange Online.](../images/enviar-email-con-alias/image3.png)
...
![Imagen 4.- Configuración para el uso de un alias de correo.](../images/enviar-email-con-alias/image4.png)
...
![Imagen 5.- Uso de un Alias para enviar correos.](../images/enviar-email-con-alias/image5.png)

Luego haga clic sobre el botón de "From", y una lista con los alias
disponibles será visible:

![Imagen 6.- Listado de alias disponibles.](../images/enviar-email-con-alias/image6.png)
...
![Imagen 7.- Alias utilizado.](../images/enviar-email-con-alias/image7.png)
