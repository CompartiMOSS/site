...
slug: "provisionando-modern-pages-y-webparts-usando-pnp"
magazineSlug: "numero-33"
author: "Luis Mañez"
authorSlug: "luis-manez"
keywords: ['SharePoint Framework']
image: "../images/provisionando-modern-pages-y-webparts-usando-pnp/image2.png"
---
...
![Imagen 1.- Despliegue de un WebPart de SPFx a nivel de tenant.](../images/provisionando-modern-pages-y-webparts-usando-pnp/image1.png)
...
![](../images/provisionando-modern-pages-y-webparts-usando-pnp/image2.png)

***Añadiendo algo de contenido a la página***

![](../images/provisionando-modern-pages-y-webparts-usando-pnp/image3.png)

![Imagen 2.- Página moderna creada de forma programática con PnP.](../images/provisionando-modern-pages-y-webparts-usando-pnp/image4.png)
...
![](../images/provisionando-modern-pages-y-webparts-usando-pnp/image5.png)

Añadiendo y configurando un WebPart OOB (List WebPart)

![](../images/provisionando-modern-pages-y-webparts-usando-pnp/image6.png)
...
![Imagen 3.- Inspeccionando la página con el SharePoint Online Client Browser](../images/provisionando-modern-pages-y-webparts-usando-pnp/imagec.png)
...
![](../images/provisionando-modern-pages-y-webparts-usando-pnp/image8.png)

Una vez descodificado tendremos:

![](../images/provisionando-modern-pages-y-webparts-usando-pnp/image9.png)
...
![](../images/provisionando-modern-pages-y-webparts-usando-pnp/image10.png)![](../images/provisionando-modern-pages-y-webparts-usando-pnp/image11.png)
