...
![Imagen 1.- Creación del Key Vault en Azure.](../images/sharepoint-y-azure-key-vault/image1.png)
...
![Imagen 2.- Ventana de manejo del Key Vault en Azure.](../images/sharepoint-y-azure-key-vault/image2.png)
...
![Imagen 3.- Creación de un secreto en el Key Vault en Azure.](../images/sharepoint-y-azure-key-vault/image3.png)
...
![Imagen 4.- URL del secreto en el Key Vault.](../images/sharepoint-y-azure-key-vault/image4.png)
...
![Imagen 5.- Registro de la aplicación.](../images/sharepoint-y-azure-key-vault/image5.png)
...
![Imagen 6.- Identificador del Registro de la aplicación.](../images/sharepoint-y-azure-key-vault/image6.png)
...
![Imagen 7.- Valor del Registro de la aplicación](../images/sharepoint-y-azure-key-vault/imagea.png)
...
![Imagen 8.- Conexión del Registro de la aplicación con el Key Vault.](../images/sharepoint-y-azure-key-vault/image8.png)

-            En la ventana de "Add Access policy" haga clic sobre "Secret permissions". En la ventana de "Secret permissions" seleccione "Get".

![Imagen 9.- Conexión del Registro de la aplicación con el Key Vault.](../images/sharepoint-y-azure-key-vault/image9.png)
