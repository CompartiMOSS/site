...
![Imagen 1.- Creando Cosmos DB Table API.](../images/usando-cosmos-db-table-api/image8.png)

Una vez creada verás que se ha creado el servicio sin ninguna tabla asociada:

![Imagen 2.- Cosmos DB Table API.](../images/usando-cosmos-db-table-api/image9.png)

También deberéis crear un Azure Storage Account:

![Imagen 3.- Azure Storage.](../images/usando-cosmos-db-table-api/imagea.png)
...
![Imagen 4.- Inserción elementos.](../images/usando-cosmos-db-table-api/imageb.png)
...
![Imagen 5.- Obteniendo elementos.](../images/usando-cosmos-db-table-api/imagec.png)
...
![Imagen 6.- Actualizando elementos.](../images/usando-cosmos-db-table-api/imaged.png)
...
![Imagen 7.- Borrando elementos.](../images/usando-cosmos-db-table-api/imagee.png)
