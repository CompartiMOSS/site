...
slug: "integracion-de-sharepoint-con-power-bi"
magazineSlug: "numero-31"
author: "Bruno Torterolo"
authorSlug: "bruno-torterolo"
keywords: ['Power BI','SharePoint']
image: "../images/integracion-de-sharepoint-con-power-bi/imagen2.png"
---
...
![Imagen 1.- Opción de compartir un informe de Power BI.](../images/integracion-de-sharepoint-con-power-bi/imagen1.png)
...
​![Imagen 2.- Access Key en Azure.](../images/integracion-de-sharepoint-con-power-bi/image5.png)

2. El segundo paso es generar el token, el cual tendrá un tiempo de expiración establecido:

![Imagen 3.- Generación del token.](../images/integracion-de-sharepoint-con-power-bi/image6.png)

3. El token es firmado con el Access Key provisto por Azure y almacenado en la aplicación.

![Imagen 4.- Firmado del token.](../images/integracion-de-sharepoint-con-power-bi/image7.png)
...
![Imagen 5.- Solicitud de la visualización del informe.](../images/integracion-de-sharepoint-con-power-bi/image8.png)

5.  Azure, a través del Workspace de Power BI verifica el token y el reporte solicitado.

![Imagen 6.- Verificación del token.](../images/integracion-de-sharepoint-con-power-bi/image9.png)

6.  Como último paso el reporte es enviado al usuario.

![Imagen 7.- Envío del informe al usuario.](../images/integracion-de-sharepoint-con-power-bi/image10.png)
...
![](../images/integracion-de-sharepoint-con-power-bi/imagen2.png)
