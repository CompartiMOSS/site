...
slug: "microsoft-operations-management-suite"
magazineSlug: "numero-31"
author: "David Rivera"
authorSlug: "david-rivera"
keywords: ['System Center','OMS','Azure']
image: "../images/microsoft-operations-management-suite/image18.png"
---
...
![Imagen 1.- Inicio de sesión en OMS.](../images/microsoft-operations-management-suite/image6.png)
...
![Imagen 2.- Definición de un área de trabajo en OMS.](../images/microsoft-operations-management-suite/image7.png)
...
![Imagen 3.- Creación de la suscripción de Azure para OMS.](../images/microsoft-operations-management-suite/image8.png)

- Ya tenemos nuestra área de trabajo creada:

![Imagen 4.- Área de Trabajo creada.](../images/microsoft-operations-management-suite/image9.png)
...
![Imagen 5.- Galería de soluciones.](../images/microsoft-operations-management-suite/image10.png)
...
![Imagen 6.- Instalación del agente de OMS.](../images/microsoft-operations-management-suite/image11.png)

- Después hacemos clic en Connected Sources y vemos la siguiente ventana.

![Imagen 7.- Detalle de fuentes conectadas en OMS.](../images/microsoft-operations-management-suite/image12.png)

- Hacemos clic en Descargar agente para Windows, lo descargamos y lo ejecutamos.

![Imagen 8.- Inicio de la instalación del agente de OMS.](../images/microsoft-operations-management-suite/image13.png)

- Es muy sencillo seguimos las indicaciones de la imagen y en menos de 5 minutos tenemos instalado el agente de OMS.

![Imagen 9.- Configuración de la instalación del agente.](../images/microsoft-operations-management-suite/image16.png)
...
![Imagen 10.- Configuración del ID y Clave del área de trabajo.](../images/microsoft-operations-management-suite/image17.png)

- En la siguiente ventana hacemos clic en instalar.

![](../images/microsoft-operations-management-suite/image18.png)
...
![](../images/microsoft-operations-management-suite/image20.png)
...
![Imagen 12.- Registro de OMS en SCOM.](../images/microsoft-operations-management-suite/image21.png)

- Nos pedirá que seleccionemos el espacio de trabajo. Seleccionamos el espacio de trabajo creado en el punto anterior.

![Imagen 13.- Selección del espacio de trabajo.](../images/microsoft-operations-management-suite/image22.png)

- En esta ventana nos pide la cuenta de Microsoft con la cual administramos OMS. La introducimos y hacemos clic en Sign in.

![Imagen 14.- Inicio de sesión en OMS.](../images/microsoft-operations-management-suite/image23.png)
...
![Imagen 15.- Fin de la conexión de SCOM con OMS.](../images/microsoft-operations-management-suite/image24.png)
