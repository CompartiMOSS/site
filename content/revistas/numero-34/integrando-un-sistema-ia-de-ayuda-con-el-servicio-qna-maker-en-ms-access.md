...
slug: "integrando-un-sistema-ia-de-ayuda-con-el-servicio-qna-maker-en-ms-access"
magazineSlug: "numero-34"
author: "Miquel “Neckkito”"
authorSlug: "miquel-neckkito"
keywords: ['Azure']
image: "../images/integrando-un-sistema-ia-de-ayuda-con-el-servicio-qna-maker-en-ms-access/image8.png"
---
...
![Ilustración 1 - Opciones de QnA Maker](../images/integrando-un-sistema-ia-de-ayuda-con-el-servicio-qna-maker-en-ms-access/image1.png)
...
![Imagen 2 .- Dando nombre a nuestro servicio.](../images/integrando-un-sistema-ia-de-ayuda-con-el-servicio-qna-maker-en-ms-access/image2.png)
...
![Imagen 3.- Elementos de control de la BD de conocimiento de nuestro servicio.](../images/integrando-un-sistema-ia-de-ayuda-con-el-servicio-qna-maker-en-ms-access/image3.png)
...
![Imagen 4.- Resultados comparativos de nuestros cambios en la BD de conocimiento.](../images/integrando-un-sistema-ia-de-ayuda-con-el-servicio-qna-maker-en-ms-access/image4.png)
...
![Imagen 5.- Ejemplo de llamada al servicio a través de REST.](../images/integrando-un-sistema-ia-de-ayuda-con-el-servicio-qna-maker-en-ms-access/image5.png)
...
![Imagen 6.- Obtención de las claves de suscripción primaria y secundaria.](../images/integrando-un-sistema-ia-de-ayuda-con-el-servicio-qna-maker-en-ms-access/image6.png)

Si seleccionamos la opción Mis Servicios (*My Services*) veremos todos los servicios que hayamos creado

![Imagen 7.- Lista de los servicios creados.](../images/integrando-un-sistema-ia-de-ayuda-con-el-servicio-qna-maker-en-ms-access/image7.png)
...
| --- | --- | --- |
| TPares | ![](../images/integrando-un-sistema-ia-de-ayuda-con-el-servicio-qna-maker-en-ms-access/image8.png)​ | Construirnos los pares y llevar un control de los mismos. Importante: indexar el campo [Par-Respuesta] |
| TServicios | ![](../images/integrando-un-sistema-ia-de-ayuda-con-el-servicio-qna-maker-en-ms-access/image9.png)​ | Llevar un control de los datos clave para acceder al servicio. En este ejemplo solo utilizaré un servicio para evitar complicar en exceso el ejemplo |
| TErrores | ![](../images/integrando-un-sistema-ia-de-ayuda-con-el-servicio-qna-maker-en-ms-access/image10.png)​ | Gestionar tanto los errores de Access como los errores devueltos por la respuesta del servicio |
| TNotificaciones | ![](../images/integrando-un-sistema-ia-de-ayuda-con-el-servicio-qna-maker-en-ms-access/image11.png)​ | Nos permitirá recibir el *feedback* de los usuarios y nos servirá de base para "entrenar" nuestro servicio |
| TCodificacion | ![](../images/integrando-un-sistema-ia-de-ayuda-con-el-servicio-qna-maker-en-ms-access/image12.png)​ | Necesaria para soslayar el problema de la codificación en español. |
...
![Imagen 8.- Estructura básica de formulario para el sistema.](../images/integrando-un-sistema-ia-de-ayuda-con-el-servicio-qna-maker-en-ms-access/image13.png)
...
![Imagen 9.- Ejemplo de pares pregunta-respuesta.](../images/integrando-un-sistema-ia-de-ayuda-con-el-servicio-qna-maker-en-ms-access/image14.png)
...
![Imagen 10.- Exportación e la consulta.](../images/integrando-un-sistema-ia-de-ayuda-con-el-servicio-qna-maker-en-ms-access/image15.png)

![Imagen 10.- Exportación e la consulta.](../images/integrando-un-sistema-ia-de-ayuda-con-el-servicio-qna-maker-en-ms-access/image16.png)
...
![Imagen 11.- Guardando el archivo como UTF-8.](../images/integrando-un-sistema-ia-de-ayuda-con-el-servicio-qna-maker-en-ms-access/image17.png)
...
![Imagen 12.- Ejemplo de datos en TCodificacion](../images/integrando-un-sistema-ia-de-ayuda-con-el-servicio-qna-maker-en-ms-access/image18.png)
...
![Imagen 13 - Esquema básico del proceso.](../images/integrando-un-sistema-ia-de-ayuda-con-el-servicio-qna-maker-en-ms-access/image19.png)
...
![](../images/integrando-un-sistema-ia-de-ayuda-con-el-servicio-qna-maker-en-ms-access/image20.png)
...
![](../images/integrando-un-sistema-ia-de-ayuda-con-el-servicio-qna-maker-en-ms-access/image21.png)

![](../images/integrando-un-sistema-ia-de-ayuda-con-el-servicio-qna-maker-en-ms-access/image22.png)
...
![](../images/integrando-un-sistema-ia-de-ayuda-con-el-servicio-qna-maker-en-ms-access/image23.png)
...
![](../images/integrando-un-sistema-ia-de-ayuda-con-el-servicio-qna-maker-en-ms-access/image24.png)
...
![Imagen 14 - Respuesta del servicio con error](../images/integrando-un-sistema-ia-de-ayuda-con-el-servicio-qna-maker-en-ms-access/image25.png)
...
![Imagen 15 - Respuesta correcta del servicio.](../images/integrando-un-sistema-ia-de-ayuda-con-el-servicio-qna-maker-en-ms-access/image26.png)
...
![](../images/integrando-un-sistema-ia-de-ayuda-con-el-servicio-qna-maker-en-ms-access/image27.png)
...
![](../images/integrando-un-sistema-ia-de-ayuda-con-el-servicio-qna-maker-en-ms-access/image28.png)
...
![Imagen 16 – Resultados obtenidos.](../images/integrando-un-sistema-ia-de-ayuda-con-el-servicio-qna-maker-en-ms-access/image29.png)

![](../images/integrando-un-sistema-ia-de-ayuda-con-el-servicio-qna-maker-en-ms-access/image30.png)
...
![](../images/integrando-un-sistema-ia-de-ayuda-con-el-servicio-qna-maker-en-ms-access/image31.png)
...
![Imagen 17 - Estructura de consulta para comprobar las notificaciones de los usuarios.](../images/integrando-un-sistema-ia-de-ayuda-con-el-servicio-qna-maker-en-ms-access/image32.png)
...
![Imagen 18 - Ejemplo de registro de notificación.](../images/integrando-un-sistema-ia-de-ayuda-con-el-servicio-qna-maker-en-ms-access/image33.png)
...
![Imagen 19 - Panel de testeo de nuestro servicio.](../images/integrando-un-sistema-ia-de-ayuda-con-el-servicio-qna-maker-en-ms-access/image34.png)
