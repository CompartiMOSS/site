...
![Imagen 1.- Simulador de Text API.](../images/sharepoint-y-azure-el-azure-text-analytics-api/image1.png)
...
![Imagen 2.- Creación del servicio de Text API.](../images/sharepoint-y-azure-el-azure-text-analytics-api/image2.png)
...
![Imagen 3.- Elemento en la Lista con los resultados del servicio de Text API.](../images/sharepoint-y-azure-el-azure-text-analytics-api/image3.png)
