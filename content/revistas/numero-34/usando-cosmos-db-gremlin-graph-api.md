...
![Imagen 1.- Creando Cosmos DB Gremlin(graph).](../images/usando-cosmos-db-gremlin-graph-api/image1.png)

Una vez creada verás que se ha creado el servicio sin ningún grafo asociado:

![Imagen 2.- Cosmos DB Gremlin graph.](../images/usando-cosmos-db-gremlin-graph-api/image2.png)
...
![Imagen 3.- Grafo de ejemplo.](../images/usando-cosmos-db-gremlin-graph-api/image3.jpeg)

Crearemos un proyecto de consola y añadimos el paquete NuGet:

![Imagen 4.- Paquete NuGet para usar Gremlin.](../images/usando-cosmos-db-gremlin-graph-api/image4.png)
...
![Imagen 5.- Settings del EndPoint.](../images/usando-cosmos-db-gremlin-graph-api/image5.png)
...
![Imagen 6.- Ejemplo de resultados.](../images/usando-cosmos-db-gremlin-graph-api/image6.png)

Ahora si vamos al portal vemos que se ha creado la colección:

![Imagen 7.- Ejemplo de resultados.](../images/usando-cosmos-db-gremlin-graph-api/image7.png)

Ahora podemos ir a ver los datos al *data explorer*:

![Imagen 8.- Data Explorer.](../images/usando-cosmos-db-gremlin-graph-api/image8.png)
