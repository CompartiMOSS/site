...
![Imagen 1.- Sección conectores personalizados en Power Automate.](../images/powerautomatepowerbiapi/image1.png)

Una vez allí iremos a crear un nuevo conector personalizado y creamos
uno desde cero

![Imagen 2.- Creando un conector personalizado.](../images/powerautomatepowerbiapi/image2.png)

Le ponemos un nombre al conector y le damos continuar

![Imagen 3.- Nombre para el conector.](../images/powerautomatepowerbiapi/image3.png)
...
![Imagen 4.- Configuración del conector.](../images/powerautomatepowerbiapi/image4.png)
...
Una vez completada esta sección damos en ![](../images/powerautomatepowerbiapi/image5.png) y continuamos con la siguiente sección.

En esta sección lo primero que debemos seleccionar es el tipo de
seguridad:

![](../images/powerautomatepowerbiapi/image6.png)

![Imagen 5.- Configurando la seguridad.](../images/powerautomatepowerbiapi/image7.png)

Seleccionamos OAuth 2.0 y nos aparecerá la siguiente pantalla:

![Imagen 6.- Configuraciones para OAuth 2.0.](../images/powerautomatepowerbiapi/image8.png)
...
![](../images/powerautomatepowerbiapi/image9.png)

![Imagen 7.- Inicio del registro de la aplicación Power BI.](../images/powerautomatepowerbiapi/image10.png)

Hacemos clic en el botón Next y comenzaremos el proceso de registro de
nuestra aplicación.

![Imagen 8.- Parámetros para configurar la App de Power BI.](../images/powerautomatepowerbiapi/image11.png)

Completamos los datos y luego vamos a la sección de API Permissions.

![Imagen 9.- Permisos para la API.](../images/powerautomatepowerbiapi/image12.png)

Completamos los datos y luego vamos a la sección de API Access.

![Imagen 10.- Permisos para la API.](../images/powerautomatepowerbiapi/image13.png)
...
![Imagen 11.- Application ID y Application secret generados.](../images/powerautomatepowerbiapi/image14.png)
...
![Imagen 12.- Vuelta a la configuración del Custom Connector.](../images/powerautomatepowerbiapi/image15.png)

Ya cargados los datos necesarios pasamos a la definición haciendo clic
en ![](../images/powerautomatepowerbiapi/image16.png)
...
![Imagen 13.- Nueva acción.](../images/powerautomatepowerbiapi/image17.png)

Debemos cargar el resumen, la descripción y el Identificador de nuestra
acción.

![Imagen 14.- Datos para configurar la nueva acción.](../images/powerautomatepowerbiapi/image18.png)

Luego vamos a crear la solicitud para esa operación.

![Imagen 15.- Nueva solicitud.](../images/powerautomatepowerbiapi/image19.png)
...
![Imagen 16.- Configuración del verbo para la solicitud](../images/powerautomatepowerbiapi/image20.png)
