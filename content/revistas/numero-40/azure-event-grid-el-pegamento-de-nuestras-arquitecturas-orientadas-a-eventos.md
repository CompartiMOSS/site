...
![Imagen 1.- Arquitectura basadas en eventos.](../images/azure-event-grid-el-pegamento-de-nuestras-arquitecturas-orientadas-a-eventos/image1.png)
...
![Imagen 2.- Azure Serverless.](../images/azure-event-grid-el-pegamento-de-nuestras-arquitecturas-orientadas-a-eventos/image2.png)
...
![Imagen 3.- Ejemplo de Trigger.](../images/azure-event-grid-el-pegamento-de-nuestras-arquitecturas-orientadas-a-eventos/image3.png)
...
![Imagen 4.- El pegamento del serverless, Azure Event Grid.](../images/azure-event-grid-el-pegamento-de-nuestras-arquitecturas-orientadas-a-eventos/image4.png)
...
![Imagen 5.- Conceptos de Azure  Event Grid.](../images/azure-event-grid-el-pegamento-de-nuestras-arquitecturas-orientadas-a-eventos/image5.png)
...
![Imagen 6.- Creando un Storage Account.](../images/azure-event-grid-el-pegamento-de-nuestras-arquitecturas-orientadas-a-eventos/image6.png)
...
![Imagen 7.- Creando un Function App.](../images/azure-event-grid-el-pegamento-de-nuestras-arquitecturas-orientadas-a-eventos/image7.png)
...
![Imagen 8.- Configurando mi plan de Functions.](../images/azure-event-grid-el-pegamento-de-nuestras-arquitecturas-orientadas-a-eventos/image8.png)

Si todo ha ido de forma correcta, al acceder al grupo de recursos deberíamos tener los siguientes servicios:

![Imagen 9.- Recursos necesarios para el ejemplo.](../images/azure-event-grid-el-pegamento-de-nuestras-arquitecturas-orientadas-a-eventos/image9.png)
...
![Imagen 10.- Creando la function.](../images/azure-event-grid-el-pegamento-de-nuestras-arquitecturas-orientadas-a-eventos/image10.png)
...
![Imagen 11.- El trigger del tipo Event Grid.](../images/azure-event-grid-el-pegamento-de-nuestras-arquitecturas-orientadas-a-eventos/image11.png)
...
![Imagen 12.- Instalando los paquetes de Event Grid.](../images/azure-event-grid-el-pegamento-de-nuestras-arquitecturas-orientadas-a-eventos/image12.png)
...
![Imagen 13.- Creando la suscripción al blob.](../images/azure-event-grid-el-pegamento-de-nuestras-arquitecturas-orientadas-a-eventos/image13.png)
...
![Imagen 14.- Definiendo el topic.](../images/azure-event-grid-el-pegamento-de-nuestras-arquitecturas-orientadas-a-eventos/image14.png)
...
![Imagen 15.- Creando el blob.](../images/azure-event-grid-el-pegamento-de-nuestras-arquitecturas-orientadas-a-eventos/image15.png)
...
![Imagen 16.- Depurando la function.](../images/azure-event-grid-el-pegamento-de-nuestras-arquitecturas-orientadas-a-eventos/image16.png)
...
![Imagen 17.- Subiendo un fichero al blob.](../images/azure-event-grid-el-pegamento-de-nuestras-arquitecturas-orientadas-a-eventos/image17.png)
...
![Imagen 18.- Capturando un evento de Event Grid.](../images/azure-event-grid-el-pegamento-de-nuestras-arquitecturas-orientadas-a-eventos/image18.png)
