...
slug: "cosmosdb-integration-testing-con-azuredevops"
magazineSlug: "numero-40"
author: "Robert Bermejo"
authorSlug: "robert-bermejo"
keywords: ['Azure','CosmosDB']
image: "../images/cosmosdb-integration-testing-con-azuredevops/image2.png"
---
...
![Imagen 1.- Emulador de CosmosDB en Visual Studio.](../images/cosmosdb-integration-testing-con-azuredevops/image1.png)

El archivo de configuración de nuestro proyecto de test debe tener la siguiente forma:

![](../images/cosmosdb-integration-testing-con-azuredevops/image2.png)
...
![Imagen 2.- Añadiendo la tarea de CosmosDB Emulator al Pipeline.](../images/cosmosdb-integration-testing-con-azuredevops/image3.png)
...
![Imagen 3.- Añadiendo la descripción de la variable de salida.](../images/cosmosdb-integration-testing-con-azuredevops/image4.png)
...
![Imagen 4.- Añadiendo la tarea PowerShell que modifica la variable.](../images/cosmosdb-integration-testing-con-azuredevops/image5.png)
...
![Imagen 5.- Build con los Integration Tests contra CosmosDB.](../images/cosmosdb-integration-testing-con-azuredevops/image6.png)
