...
![Imagen 1.- Creación del recurso.](../images/integrando-azure-cognitives-services-con-sharepoint-online/image1.png)

-   Buscamos en el cuadro de búsqueda "**Computer Vision**".

![Imagen 2.- Búsqueda del servicio de Computer Vision.](../images/integrando-azure-cognitives-services-con-sharepoint-online/image2.png)

![Imagen 3.- Creación del servicio.](../images/integrando-azure-cognitives-services-con-sharepoint-online/image3.png)

-   Lo creamos haciendo clic en "Create". En la siguiente pantalla
    debemos seleccionar una serie de valores.

![Imagen 4.- Configuraciones del servicio.](../images/integrando-azure-cognitives-services-con-sharepoint-online/image4.png)

-   Primero seleccionamos la suscripción y el grupo de recursos en que
    queremos alojar nuestro nuevo recurso:

![Imagen 5.- Selección de la suscripción.](../images/integrando-azure-cognitives-services-con-sharepoint-online/image5.png)

-   Segundo elegimos la región de Azure en la que lo queremos
    aprovisionar y luego le damos un nombre:

![Imagen 6.- Selección de la región de Azure.](../images/integrando-azure-cognitives-services-con-sharepoint-online/image6.png)
...
![Imagen 7.- Selección del Pricing Tier.](../images/integrando-azure-cognitives-services-con-sharepoint-online/image7.png)
...
![Imagen 8.- Resumen parametrizaciones realizadas.](../images/integrando-azure-cognitives-services-con-sharepoint-online/image8.png)
...
![Imagen 9.- Inicio de la creación del Flujo de Power Automate.](../images/integrando-azure-cognitives-services-con-sharepoint-online/image9.png)

-   Cundo hacemos clic en Crear un flujo nos aparecerá el siguiente pop
    up.

![Imagen 10.- Acceso a todos los flujos.](../images/integrando-azure-cognitives-services-con-sharepoint-online/image10.png)

-   Hacemos clic en "Ver los flujos" y esto nos llevara al sitio de
    Power Automate y allí debemos creamos un nuevo flujo.

![Imagen 11.- Plantilla de inicio para crear el Flujo.](../images/integrando-azure-cognitives-services-con-sharepoint-online/image11.png)

-   Luego le damos un nombre y seleccionamos el disparador de tipo "When
    a file is created in a folder" y lo Creamos.

![Imagen 12.- Configuraciones iniciales del Flujo.](../images/integrando-azure-cognitives-services-con-sharepoint-online/image12.png)
...
![Imagen 13.- Parámetros de configuración de la acción.](../images/integrando-azure-cognitives-services-con-sharepoint-online/image13.png)

-   Después agregamos el paso de procesamiento de imagen y lo
    configuramos:

![Imagen 14.- Acción para realizar OCR sobre imágenes.](../images/integrando-azure-cognitives-services-con-sharepoint-online/image14.png)

![Imagen 15.- Parámetros de configuración de conexión a Computer Vision API.](../images/integrando-azure-cognitives-services-con-sharepoint-online/image15.png)
...
![Imagen 16.- Parámetros KEY 1 y ENDPOINT de Computer Vision API.](../images/integrando-azure-cognitives-services-con-sharepoint-online/image16.png)

-   Una vez creada la conexión le decimos cual es el archivo que debe
    procesar:

![Imagen 17.- Configuración del archivo a procesar.](../images/integrando-azure-cognitives-services-con-sharepoint-online/image17.png)
...
![Imagen 18.- Contenido dinámico.](../images/integrando-azure-cognitives-services-con-sharepoint-online/image18.png)

-   Paso siguiente inicializamos y cargamos la variable con el resultado
    del procesamiento:

![Imagen 19.- Configuraciones de las variables.](../images/integrando-azure-cognitives-services-con-sharepoint-online/image19.png)

-   Por último, creamos el elemento de lista de SharePoint y le
    adjuntamos la imagen.

![Imagen 20.- Creación del elemento de lista.](../images/integrando-azure-cognitives-services-con-sharepoint-online/image20.png)
