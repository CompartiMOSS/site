...
![**Imagen** **1.- Opción de "Run only users" en un flujo de desencadenamiento manual.**](../images/graphapi-y-power-automate/image1.png)

![**Imagen** **2.- Opción inexistente de "Run only users" en un flujo automatizado con dataverse.**](../images/graphapi-y-power-automate/image2.png)
...
![**Imagen** **3.- Ejemplo de cómo se muestran los permisos necesarios para poder ejecutar la API de Graph.**](../images/graphapi-y-power-automate/image3.png)

Después necesitaremos crear un secreto para este registro de aplicación.

![**Imagen** **4.- Cómo crear un secreto en nuestro registro de aplicación.**](../images/graphapi-y-power-automate/image4.png)
...
![](../images/graphapi-y-power-automate/image5.png)
...
![**Imagen** **5.- Ejemplo de utilización de la API de Graph en Power Automate para la creación de un equipo de Teams.**](../images/graphapi-y-power-automate/image6.png)
...
![**Imagen** **6.- Configuración de la autenticación y autorización del conector.**](../images/graphapi-y-power-automate/image7.png)
...
![**Imagen** **7.- Conectores con Azure Key Vault en Power Automate.**](../images/graphapi-y-power-automate/image8.png)
