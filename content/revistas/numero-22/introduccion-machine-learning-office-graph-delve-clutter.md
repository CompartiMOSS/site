...
slug: "introduccion-machine-learning-office-graph-delve-clutter"
...
image: "../images/introduccion-machine-learning-office-graph-delve-clutter/image001.jpg"
---
...
![](../images/introduccion-machine-learning-office-graph-delve-clutter/image001.jpg)
...
![](../images/introduccion-machine-learning-office-graph-delve-clutter/image003.png)Graph descubre el vínculo entre las entidades mediante la conjunción de 3 elementos que son el Actor (quién o "Actor"), la Acción (qué o "Edge") y el Objeto (dónde u "Object"). De esta forma podríamos obtener relaciones simples del tipo "Javier ha modificado Carta.docx" (actor, acción y objeto), u otras más complejas como "Alberto está trabajando con Articulo\_CompartiMOSS.pptx" (en este caso la acción no es simple sino que intrínsecamente implica varias iteraciones).

La sintaxis de estas consultas se construye como:

![](../images/introduccion-machine-learning-office-graph-delve-clutter/image004.png)
...
![](../images/introduccion-machine-learning-office-graph-delve-clutter/image005.png)
...
![](../images/introduccion-machine-learning-office-graph-delve-clutter/image006.png)
...
![](../images/introduccion-machine-learning-office-graph-delve-clutter/image007.png)
