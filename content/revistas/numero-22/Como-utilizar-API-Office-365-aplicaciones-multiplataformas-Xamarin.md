...
![Imagen 1.- Esquema de desarrollo tradicional con Xamarin.](../images/Como-utilizar-API-Office-365-aplicaciones-multiplataformas-Xamarin/imagen1.png)
...
![Imagen 2.- Arquitectura de Xamarin Forms](../images/Como-utilizar-API-Office-365-aplicaciones-multiplataformas-Xamarin/imagen2.png)
...
![Imagen 3.- Paso 1 de autenticación](../images/Como-utilizar-API-Office-365-aplicaciones-multiplataformas-Xamarin/imagen3.png)
...
![Imagen 4.- Paso 3 de autenticación.](../images/Como-utilizar-API-Office-365-aplicaciones-multiplataformas-Xamarin/imagen4.png)

4. Su aplicación obtiene el código de autorización. Azure devuelve un token de acceso.

![Imagen 5.- Paso 4 de autenciación](../images/Como-utilizar-API-Office-365-aplicaciones-multiplataformas-Xamarin/imagen5.png)
...
![Imagen 6.- Paso 5 de autenticación](../images/Como-utilizar-API-Office-365-aplicaciones-multiplataformas-Xamarin/imagen6.png)
...
![Imagen 7.- Paso 6 de autenticación](../images/Como-utilizar-API-Office-365-aplicaciones-multiplataformas-Xamarin/imagen7.png)

7. La aplicación ahora puede llamar a la Oficina 365 APIs utilizando el URI del Discovery Service  y el token de acceso.

![Imagen 8.- Peticiones a la APIs de Office365](../images/Como-utilizar-API-Office-365-aplicaciones-multiplataformas-Xamarin/imagen8.png)
...
![Imagen 9.- Tipo de Proyecto a elegir](../images/Como-utilizar-API-Office-365-aplicaciones-multiplataformas-Xamarin/imagen9.png)
...
![Imagen 10.- Selección plataformas donde se puede utilizar la biblioteca](../images/Como-utilizar-API-Office-365-aplicaciones-multiplataformas-Xamarin/imagen10.png)
...
![Imagen 11.- Instalación Paquete ADAL en NuGet.](../images/Como-utilizar-API-Office-365-aplicaciones-multiplataformas-Xamarin/imagen11.png)
...
![Imagen 12.- Agregamos proyecto Android a la Solución.](../images/Como-utilizar-API-Office-365-aplicaciones-multiplataformas-Xamarin/imagen12.png)
...
![Imagen 13.- Estructura del Proyecto Android.](../images/Como-utilizar-API-Office-365-aplicaciones-multiplataformas-Xamarin/imagen13.png)
...
![Imagen 14.- Aplicación Android accediendo a las APIS de Office 365.](../images/Como-utilizar-API-Office-365-aplicaciones-multiplataformas-Xamarin/imagen14.png)
