...
![Imagen 1.- Creación del usuario en Office 365.](../images/la-busqueda-tambien-es-hibrida/image1.png)
...
![Imagen 2.- Descarga de FixIt.](../images/la-busqueda-tambien-es-hibrida/image2.png)

· La herramienta de Directory Sync:

![Imagen 3.- Descarga de DirSync.](../images/la-busqueda-tambien-es-hibrida/image3.png)
...
![Imagen 4.- Activación de la sincronización de directorio.](../images/la-busqueda-tambien-es-hibrida/image4.png)
...
![Imagen 5.- Ejecución de FixIt.](../images/la-busqueda-tambien-es-hibrida/image5.png)
...
![Imagen 6.- Inicio del asistente de instalación DirSync.](../images/la-busqueda-tambien-es-hibrida/image6.png)
...
![Imagen 7.- Proceso de instalación de DirSync.](../images/la-busqueda-tambien-es-hibrida/image7.png)
...
![Imagen 8.- Wizar de configuración de DirSync.](../images/la-busqueda-tambien-es-hibrida/image8.png)
Los datos solicitados son:
· Credenciales del administrador global de Office 365 365.
· Credenciales de un administrador del dominio OnPremise.

![Imagen 9.- Credenciales necesarias para utilizar DirSync.](../images/la-busqueda-tambien-es-hibrida/image9.png)
...
![Imagen 10.- Configuraciones “Hybrid Deployment” y “Passwod Synchronization”.](../images/la-busqueda-tambien-es-hibrida/image10.png)

![Imagen 10.- Configuraciones “Hybrid Deployment” y “Passwod Synchronization”.](../images/la-busqueda-tambien-es-hibrida/image11.png)
...
![Imagen 11.- Fin del asistente de configuración de DirSync.](../images/la-busqueda-tambien-es-hibrida/image12.png)
...
![Imagen 12.- Confirmación de éxito en la creación de la Aplicación de Servicio.](../images/la-busqueda-tambien-es-hibrida/image13.png)
...
​![Imagen 13.- Instalación del Microsoft Online Services Sign-In Assistant.](../images/la-busqueda-tambien-es-hibrida/image14.png)

2. Instalar el módulo de Azure Active Directory para Windows Powershell (64 bits)

![Imagen 14.- Instalación del Módulo de PowerShell para Azure AD.](../images/la-busqueda-tambien-es-hibrida/image15.png)
...
![Imagen 15.- Instalación del Módulo de PowerShell para Azure AD.](../images/la-busqueda-tambien-es-hibrida/image16.png)
...
![Imagen 16.- Especificando la dirección base de SharePoint Online.](../images/la-busqueda-tambien-es-hibrida/image17.png)
...
![Imagen 17.- Carpeta compartida en el servidor de SharePoint.](../images/la-busqueda-tambien-es-hibrida/image18.png)
...
![Imagen 18.- Acceso a la gestión de aplicaciones de servicio.](../images/la-busqueda-tambien-es-hibrida/image19.png)

> 3. Pulsar sobre la aplicación de servicio de búsquedas Cloud que hemos creado.

![Imagen 19.- Aplicación de Servicio Creada.](../images/la-busqueda-tambien-es-hibrida/image20.png)

> 4. En la página de administración de la búsqueda, en la sección de Crawling, pulsar en Content Sources.

![Imagen 20.- Enlace Content Sources.](../images/la-busqueda-tambien-es-hibrida/image21.png)
...
![Imagen 21.- Configuración del Origen de Contenido. ](../images/la-busqueda-tambien-es-hibrida/image22.png)
...
![Imagen 22.- Acceso a la configuración del centro de búsquedas en SharePoint Online.](../images/la-busqueda-tambien-es-hibrida/image23.png)
...
![Imagen 23.- Configuración de la URL del centro de búsquedas.](../images/la-busqueda-tambien-es-hibrida/image24.png)
...
![Imagen 24.- Comprobación de que la búsqueda híbrida está operativa.](../images/la-busqueda-tambien-es-hibrida/image25.png)
