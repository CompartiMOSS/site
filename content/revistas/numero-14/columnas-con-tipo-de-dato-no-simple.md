...
![Muestra los tipos de columnas de una lista o biblioteca disponibles en SharePoint 2010](../images/columnas-con-tipo-de-dato-no-simple/image1.png)
...
![Código de Contexto](../images/columnas-con-tipo-de-dato-no-simple/image2.png)
...
![Región para tipos de dato Choice](../images/columnas-con-tipo-de-dato-no-simple/image3.png)
...
![Control PeopleEditor](../images/columnas-con-tipo-de-dato-no-simple/image4.png)

![Crear el control PeopleEditor y seteo de propiepades](../images/columnas-con-tipo-de-dato-no-simple/image5.png)

![Luego de crear el control, se debe setear el valor elegido por el usuario](../images/columnas-con-tipo-de-dato-no-simple/image6.png)
...
![](../images/columnas-con-tipo-de-dato-no-simple/image7.png)
...
![Obtener las propiedades del campo BusinessData](../images/columnas-con-tipo-de-dato-no-simple/image8.png)
...
![Obtener el tipo de contenido externo con los datos previamente obtenidos](../images/columnas-con-tipo-de-dato-no-simple/image9.png)

Solo nos resta ahora encontrar setear el valor al campo

![Obtener la instancia y asignar el valor al control ItemPicker](../images/columnas-con-tipo-de-dato-no-simple/image10.png)

Para realizar esto me ayudo de un par de funciones que defino aquí:

![Función GetEntitityInstanceFromID ](../images/columnas-con-tipo-de-dato-no-simple/image11.png)

![Función GetTypedIDValue](../images/columnas-con-tipo-de-dato-no-simple/image12.png)
...
![Ejemplo de Control para Taxonomies](../images/columnas-con-tipo-de-dato-no-simple/image13.png)

Debemos empezar por obtener el campo para conocer sus propiedades:

![Obtener las propiedades del TaxonomyField](../images/columnas-con-tipo-de-dato-no-simple/image14.png)
...
![](../images/columnas-con-tipo-de-dato-no-simple/image15.png)
