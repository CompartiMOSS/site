...
![Creación de una página desde la interfaz de usuario de SharePoint](../images/integracion-mapas-client-side-rendering/image1.png)

![Creación de una página desde la interfaz de usuario de SharePoint](../images/integracion-mapas-client-side-rendering/image2.png)

- Editamos la página y le insertamos un código embebido:

![Inserción de código embebido en una página](../images/integracion-mapas-client-side-rendering/image3.png)
...
![Aspecto visual del código insertado](../images/integracion-mapas-client-side-rendering/image4.png)
...
![Representación de una columna de coordenadas en la lista](../images/integracion-mapas-client-side-rendering/image5.png)
...
![Obtención de información de coordenadas con Bing Maps](../images/integracion-mapas-client-side-rendering/image6.png)

Si pongo las coordenadas:

![Configurando los valores de las coordenadas en el campo de geolocalización](../images/integracion-mapas-client-side-rendering/image7.png)

Vemos como SharePoint automáticamente nos representa este punto en el mapa:

![Representación de la información de coordenadas en un mapa de Bing Maps](../images/integracion-mapas-client-side-rendering/image8.png)
...
![Acceso a la información geolocalizada desde la vista de lista](../images/integracion-mapas-client-side-rendering/image9.png)
...
![Acción para crear una vista de lista en SharePoint](../images/integracion-mapas-client-side-rendering/image10.png)

- De tipo Map View:

![Opción para crear una vista de tipo “Map View”](../images/integracion-mapas-client-side-rendering/image11.png)

- Y aquí tenemos nuestros puntos de interés:

![Vista de puntos de interés](../images/integracion-mapas-client-side-rendering/image12.png)
