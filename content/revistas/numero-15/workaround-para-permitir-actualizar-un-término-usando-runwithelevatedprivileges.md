...
![Escenario de partida](../images/workaround-update-term-usando-privilegios/image1.png)
...
![Listado 1.- Código para actualizar el Term seleccionado usando RunWithElevatedPrivileges](../images/workaround-update-term-usando-privilegios/image2.png)
...
![Error de permisos al lanzar el código del listado 1](../images/workaround-update-term-usando-privilegios/image3.png)
...
![Listado 2.- Código completo solución al problema planteado](../images/workaround-update-term-usando-privilegios/image4.png)
