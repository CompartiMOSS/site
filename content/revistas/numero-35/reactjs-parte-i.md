...
![Imagen 1.- Modelo de Two Binding.](../images/reactjs-parte-i/image1.png)

Conforme vamos añadiendo más controladores a la aplicación nuestro modelo se complica mucho más:

![Imagen 2.- Modelo con varios controladores.](../images/reactjs-parte-i/image2.png)

Con una arquitectura Flux la secuencia de la aplicación se simplifica mucho más quedando de la siguiente forma:

![Imagen 3.- Secuencia de la aplicación con una arquitectura Flux.](../images/reactjs-parte-i/image3.png)

Y aunque incrementemos el número de vistas y de “Dispatch/Controladores” la aplicación no se complica más de la cuenta:

![Imagen 4.- Aplicación con un mayor número de Dispatch / Controladores.](../images/reactjs-parte-i/image4.png)
...
![](../images/reactjs-parte-i/image5.png)
