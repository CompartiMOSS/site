...
![Imagen 1.- Sitio de PWA en castellano.](../images/es-project-server-online-realmente-multiidioma/image1.png)

El mismo sitio, cambiando el idioma por defecto del usuario a inglés:

![Imagen 2.- Sitio de PWA con cambio de idioma aplicado.](../images/es-project-server-online-realmente-multiidioma/image2.png)
...
![Imagen 3.- Campo personalizado.](../images/es-project-server-online-realmente-multiidioma/image3.png)

Cuando cambiemos a la interfaz en inglés seguirá llamándose "Mi campo":

![Imagen 4.- Campo personalizado tras aplicar el cambio de idioma.](../images/es-project-server-online-realmente-multiidioma/image4.png)
...
![Imagen 5.- Efecto de cambio del campo personalizado en inglés.](../images/es-project-server-online-realmente-multiidioma/image5.png)
