...
slug: "sharepoint-2013-client-side-rendering-en-detalle"
magazineSlug: "numero-27"
author: "José Quinto Zamora"
authorSlug: "jose-quinto-zamora"
keywords: ['SharePoint 2013','JavaScript']
image: "../images/sharepoint-2013-client-side-rendering-en-detalle/image6.png"
---
...
![Imagen 1.- Proceso de transformación de CSR.](../images/sharepoint-2013-client-side-rendering-en-detalle/image1.png)
...
![Imagen 2.- Ámbitos para configurar una plantilla para CSR.](../images/sharepoint-2013-client-side-rendering-en-detalle/image2.png)
...
![Imagen 3.- Librería JavaScript que se cargan en un sitio de Grupo.](../images/sharepoint-2013-client-side-rendering-en-detalle/image20.png)
...
![Imagen 4.- Otros archivos JavaScript que se cargan después de clienttemplates.js.](../images/sharepoint-2013-client-side-rendering-en-detalle/image4.png)
...
![Imagen 5.- Ruta de clienttemplates.js.](../images/sharepoint-2013-client-side-rendering-en-detalle/image5.png)
...
![](../images/sharepoint-2013-client-side-rendering-en-detalle/image6.png)
...
![](../images/sharepoint-2013-client-side-rendering-en-detalle/image7.png)
...
![](../images/sharepoint-2013-client-side-rendering-en-detalle/image8.png)
...
![](../images/sharepoint-2013-client-side-rendering-en-detalle/image9.png)
...
![Imagen 6.- Depuración de la función RegisterTemplateOverrides.](../images/sharepoint-2013-client-side-rendering-en-detalle/image10.png)

3. Usamos el textbox para filtrar por "clienttemplate".

![Imagen 7.- Uso del textbox para filtrar.](../images/sharepoint-2013-client-side-rendering-en-detalle/image11.png)

4. Botón derecho en el fichero clienttemplates.js y clicamos "Open in Sources panel".

![Imagen 8.- Opción “Open in sources panel”.](../images/sharepoint-2013-client-side-rendering-en-detalle/image12.png)
...
![](../images/sharepoint-2013-client-side-rendering-en-detalle/image13.png)

6. Una vez tenemos el código formateado, clicamos Control + F para buscar sobre él.

![Imagen 9.- Código formateado.](../images/sharepoint-2013-client-side-rendering-en-detalle/image14.png)

7. Buscamos el nombre de la función y le asignamos el punto de interrupción.

![Imagen 10.- Asignación de punto de ruptura.](../images/sharepoint-2013-client-side-rendering-en-detalle/image15.png)
...
![](../images/sharepoint-2013-client-side-rendering-en-detalle/image16.png)
...
![](../images/sharepoint-2013-client-side-rendering-en-detalle/image17.png)
...
![](../images/sharepoint-2013-client-side-rendering-en-detalle/image18.png)

Templates aplicadas hasta el momento:**registeredOverrides**:

![](../images/sharepoint-2013-client-side-rendering-en-detalle/image19.png)

Y después de hacer el merge:

![](../images/sharepoint-2013-client-side-rendering-en-detalle/image20.png)
