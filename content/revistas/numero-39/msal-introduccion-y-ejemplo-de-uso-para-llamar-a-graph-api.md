...
slug: "msal-introduccion-y-ejemplo-de-uso-para-llamar-a-graph-api"
magazineSlug: "numero-39"
author: "Luis Mañez"
authorSlug: "luis-manez"
keywords: ['Graph','Azure AD','MSAL']
image: "../images/msal-introduccion-y-ejemplo-de-uso-para-llamar-a-graph-api/image8.png"
---
...
![Imagen 1.- Arquitectura de referencia para consumir APIs de forma segura mediante Azure AD.](../images/msal-introduccion-y-ejemplo-de-uso-para-llamar-a-graph-api/image1.png)
...
![Imagen 2.- Paquete NuGet de MSAL.](../images/msal-introduccion-y-ejemplo-de-uso-para-llamar-a-graph-api/image2.png)
...
![Imagen 3.- Acceso al registro de la App en Azure AD.](../images/msal-introduccion-y-ejemplo-de-uso-para-llamar-a-graph-api/image3.png)
...
![Imagen 4.- Generación del Client Secret.](../images/msal-introduccion-y-ejemplo-de-uso-para-llamar-a-graph-api/image4.png)
...
![Imagen 5.- Añadiendo permisos a la aplicación.](../images/msal-introduccion-y-ejemplo-de-uso-para-llamar-a-graph-api/image5.png)

Para nuestro ejemplo vamos a leer los grupos, así que solicitamos permisos para ello:​

![Imagen 6.- Permisos configurados.](../images/msal-introduccion-y-ejemplo-de-uso-para-llamar-a-graph-api/image6.png)
...
![Imagen 7.- Garantizando el consentimiento requerido por la aplicación.](../images/msal-introduccion-y-ejemplo-de-uso-para-llamar-a-graph-api/image7.png)
...
![](../images/msal-introduccion-y-ejemplo-de-uso-para-llamar-a-graph-api/image8.png)
...
![](../images/msal-introduccion-y-ejemplo-de-uso-para-llamar-a-graph-api/image9.png)
