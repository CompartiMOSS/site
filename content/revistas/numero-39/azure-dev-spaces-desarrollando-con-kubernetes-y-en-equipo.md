...
slug: "azure-dev-spaces-desarrollando-con-kubernetes-y-en-equipo"
magazineSlug: "numero-39"
author: "Sergio Hernandez Mancebo"
authorSlug: "sergio-hernandez-mancebo"
keywords: ['Azure','Azure Dev Spaces']
image: "../images/azure-dev-spaces-desarrollando-con-kubernetes-y-en-equipo/image8.png"
---
...
![Imagen 1.- Elementos de Docker.](../images/azure-dev-spaces-desarrollando-con-kubernetes-y-en-equipo/image1.png)
...
![Imagen 2.- VMs vs Docker.](../images/azure-dev-spaces-desarrollando-con-kubernetes-y-en-equipo/image3.png)
...
![Imagen 3.- PODS.](../images/azure-dev-spaces-desarrollando-con-kubernetes-y-en-equipo/image4.png)
...
Azure Dev Spaces, nace precisamente para cubrir esta necesidad, y no es otra que facilitar el desarrollo de aplicaciones en equipo, con la "particularidad" de que por debajo lo que hace este servicio es implementar un clúster de Kubernetes de AKS, y nos permite depurar en local este mismo. De esta forma podemos trabajar en equipo, y trabajar con una arquitectura  basada en contendores y Kubernetes, pero desde un entorno local.
 ![Imagen 6.- Azure Dev Space.](../images/azure-dev-spaces-desarrollando-con-kubernetes-y-en-equipo/image7.png)
...
![](../images/azure-dev-spaces-desarrollando-con-kubernetes-y-en-equipo/image8.png)
...
![Imagen 7.- Portal Azure AKS.](../images/azure-dev-spaces-desarrollando-con-kubernetes-y-en-equipo/image9.png)
...
![Imagen 8.- Tools Kubernetes VS.](../images/azure-dev-spaces-desarrollando-con-kubernetes-y-en-equipo/image10.png)
...
![Imagen 9.- Aplicación MVC.](../images/azure-dev-spaces-desarrollando-con-kubernetes-y-en-equipo/image11.png)
...
![Imagen 10.- Configurando Azure Dev Space.](../images/azure-dev-spaces-desarrollando-con-kubernetes-y-en-equipo/image12.png)
...
![Imagen 11.- App desplegada en AKS.](../images/azure-dev-spaces-desarrollando-con-kubernetes-y-en-equipo/image13.png)
...
![Imagen 12.- Creando un API Net Core.](../images/azure-dev-spaces-desarrollando-con-kubernetes-y-en-equipo/image14.png)
...
![Imagen 13.- Creando un espacio de desarrollo.](../images/azure-dev-spaces-desarrollando-con-kubernetes-y-en-equipo/image15.png)
...
![Imagen 14.- Mi espacio personal.](../images/azure-dev-spaces-desarrollando-con-kubernetes-y-en-equipo/image16.png)
...
![Imagen 15.- Cambio en el api.](../images/azure-dev-spaces-desarrollando-con-kubernetes-y-en-equipo/image17.png)
...
![Imagen 16.- Resultado del nuevo api.](../images/azure-dev-spaces-desarrollando-con-kubernetes-y-en-equipo/image18.png)

Por el contario en el espacio original default, tenemos el resultado original del API en la pantalla contacto.

![Imagen 17.- Api original.](../images/azure-dev-spaces-desarrollando-con-kubernetes-y-en-equipo/image19.png)
...
![](../images/azure-dev-spaces-desarrollando-con-kubernetes-y-en-equipo/image20.png)
