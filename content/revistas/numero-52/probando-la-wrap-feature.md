...
![Imagen 1.- Creación de un nuevo entorno.](../images/probando-la-wrap-feature/image1.png)

Al cabo de un breve espacio de tiempo, nos aparecerá el entorno como *Ready*.

![Imagen 2.- Entorno disponible.](../images/probando-la-wrap-feature/image2.png)
...
![Imagen 3.- Acceso a la sección Dynamics 365 apps.](../images/probando-la-wrap-feature/image3.png)
...
![Imagen 4.- Seleccionando e instalando la característica.](../images/probando-la-wrap-feature/image4.png)
...
![Imagen 5.- Selección del entorno en el que instalar la característica.](../images/probando-la-wrap-feature/image5.png)

Al poco tiempo, veremos que la nueva característica está instalada correctamente:

![Imagen 6.- Característica instalada correctamente.](../images/probando-la-wrap-feature/image6.png)
...
![Imagen 7.- Aplicación inicial.](../images/probando-la-wrap-feature/image7.png)

Y mi solución dentro del Entorno USA quedaría de la siguiente forma:

![Imagen 8.- Solución dentro del entorno.](../images/probando-la-wrap-feature/image8.png)
...
![Imagen 9.- Variables de entorno a modificar.](../images/probando-la-wrap-feature/image9.png)
...
![Imagen 10.- Generación de claves y Hash de firma.](../images/probando-la-wrap-feature/image10.png)
...
![Imagen 11.- Comandos a ejecutar.](../images/probando-la-wrap-feature/image11.png)

![Imagen 12.- Archivo jks generado.](../images/probando-la-wrap-feature/image12.png)
...
![Imagen 13.- Exportar certificado y Hash.](../images/probando-la-wrap-feature/image13.png)
...
![Imagen 14.- Registro de la Aplicación en Azure AD.](../images/probando-la-wrap-feature/image14.png)
...
![Imagen 15.- Nombre del registro de aplicaciones y tipo de cuentas.](../images/probando-la-wrap-feature/image15.png)
...
![Imagen 16.- Selección de plataforma.](../images/probando-la-wrap-feature/image16.png)
...
![Imagen 17.- Configuración del paquete de Android.](../images/probando-la-wrap-feature/image17.png)

Al pulsar **Configure**, se os generará la "*Redirect URI*" que
estábamos buscando (que empezará por *msauth*):

![Imagen 18.- URL de redirección](../images/probando-la-wrap-feature/image18.png)
...
![Imagen 19.- Añadiendo permisos.](../images/probando-la-wrap-feature/image19.png)
...
![Imagen 20.- Permisos configurados.](../images/probando-la-wrap-feature/image20.png)
...
![Imagen 20.- App ID.](../images/probando-la-wrap-feature/image21.png)
...
![Imagen 21.- Permitiendo aplicaciones registradas.](../images/probando-la-wrap-feature/image22.png)
...
![Imagen 22.- Creando App Center container.](../images/probando-la-wrap-feature/image23.png)
...
![Imagen 23.- Añadiendo una nueva App.](../images/probando-la-wrap-feature/image24.png)
...
![Imagen 24.- URL De la App creada.](../images/probando-la-wrap-feature/image25.png)
...
![Imagen 25.- API Token.](../images/probando-la-wrap-feature/image26.png)
...
![Imagen 26.- Creando el Wrap Project.](../images/probando-la-wrap-feature/image27.png)
...
![Imagen 27.- Display Options.](../images/probando-la-wrap-feature/image28.png)
...
![Imagen 28.- Generación del paquete.](../images/probando-la-wrap-feature/image29.png)
...
![Imagen 29.- Paquete generado.](../images/probando-la-wrap-feature/image30.png)
...
![Imagen 30.- Versión de la aplicación generada.](../images/probando-la-wrap-feature/image31.png)

Para descargar el fichero apk, bastará con que pulséis sobre esa reléase
y, en el panel derecho, pulséis el botón "**Download**".

![Imagen 31.- Descarga del fichero apk.](../images/probando-la-wrap-feature/image32.png)
...
![Imagen 32.- Ubicación de apksigner.](../images/probando-la-wrap-feature/image33.png)
...
![Imagen 32.- Firmando el paquete.](../images/probando-la-wrap-feature/image34.png)
...
![Imagen 32.- Paquete sin firmar.](../images/probando-la-wrap-feature/image35.png)
...
![Imagen 33.- Firmando el paquete.](../images/probando-la-wrap-feature/image36.png)
...
![Imagen 34.- Paquete firmado.](../images/probando-la-wrap-feature/image37.png)
...
![Imagen 35.- Instalando el paquete en el Smartphone.](../images/probando-la-wrap-feature/image38.png)
...
![Imagen 36.- Pantalla de inicio.](../images/probando-la-wrap-feature/image39.png)
...
![Imagen 37.- Aplicación desplegada.](../images/probando-la-wrap-feature/image40.png)
