...
![Imagen 1.- Diseñando la Adaptive Card en el Designer.](../images/enviar-una-adaptive-card-por-teams-y-esperar-su-respuestav3/image1.png)
...
![Imagen 2.- Trigger del Flow de Power Automate a crear.](../images/enviar-una-adaptive-card-por-teams-y-esperar-su-respuestav3/image2.png)

![Imagen 3.- Acciones dentro del Flow a crear.](../images/enviar-una-adaptive-card-por-teams-y-esperar-su-respuestav3/image3.png)
...
![Imagen 4.- Configuración de la acción Update Item.](../images/enviar-una-adaptive-card-por-teams-y-esperar-su-respuestav3/image4.png)
...
![Imagen 5.- Elemento a crear.](../images/enviar-una-adaptive-card-por-teams-y-esperar-su-respuestav3/image5.png)

2.  La Adaptive Card llega a nuestro Teams:

![Imagen 6.- Adaptive Card enviada a Teams.](../images/enviar-una-adaptive-card-por-teams-y-esperar-su-respuestav3/image6.png)

3.  Respondemos y enviamos la respuesta, inmediatamente se actualiza la
    Adaptive Card

![Imagen 7.- Respondiendo en la Adaptive Card.](../images/enviar-una-adaptive-card-por-teams-y-esperar-su-respuestav3/image7.jpg)

4.  Vemos en nuestro sitio SharePoint que el elemento efectivamente se
    actualizó.

![Imagen 8.- Resultado en SharePoint.](../images/enviar-una-adaptive-card-por-teams-y-esperar-su-respuestav3/image8.png)
