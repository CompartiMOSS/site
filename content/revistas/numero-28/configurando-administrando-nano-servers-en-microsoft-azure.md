...
![Imagen 1.- Opción de crear Virtual Machine en Microsoft Azure.](../images/configurando-administrando-nano-servers-en-microsoft-azure/image1.jpeg)
...
![Imagen 2.- Creación de la máquina virtual desde la Galería de máquinas virtuales de Azure.](../images/configurando-administrando-nano-servers-en-microsoft-azure/image2.png)

·          Ahora  seleccionamos  la plantilla: Windows Server 2016 TP – Nano Server:

![Imagen 3.- Selección de la plantilla de Nano Server.](../images/configurando-administrando-nano-servers-en-microsoft-azure/image3.png)
...
![Imagen 4.- Configuración hardware del Nano Server.](../images/configurando-administrando-nano-servers-en-microsoft-azure/image4.png)
...
![Imagen 5.- Configuración del acceso a la máquina virtual y de la suscripción.](../images/configurando-administrando-nano-servers-en-microsoft-azure/image5.png)
...
![Imagen 6.- Configuración de las opciones de seguridad.](../images/configurando-administrando-nano-servers-en-microsoft-azure/image6.png)

·          ¡Finalizado!, ya tenemos nuestro Nano Server instalado y ejecutándose dentro de nuestra suscripción.

![Imagen 7.- Nano Server instalado y en ejecución.](../images/configurando-administrando-nano-servers-en-microsoft-azure/image7.png)
...
![Imagen 8.- Descarga de las herramientas necesarias.](../images/configurando-administrando-nano-servers-en-microsoft-azure/image8.jpeg)

3. Descarga el Paquete e instálalo:

![Imagen 9.- Inicio de la instalación de las herramientas.](../images/configurando-administrando-nano-servers-en-microsoft-azure/image9.png)
...
![Imagen 11.- Ejecución de Get-AzurePublishSettingsFile.](../images/configurando-administrando-nano-servers-en-microsoft-azure/image11.png)
...
![Imagen 12.- Ventana para descargar el archivo de conexión segura.](../images/configurando-administrando-nano-servers-en-microsoft-azure/image12.png)

![Imagen 13.- Descarga del archivo de conexión.](../images/configurando-administrando-nano-servers-en-microsoft-azure/image13.png)
...
![Imagen 14.- Importando en archivo de conexión con PowerShell.](../images/configurando-administrando-nano-servers-en-microsoft-azure/image14.png)

![Imagen 15.- Resultado de la importación.](../images/configurando-administrando-nano-servers-en-microsoft-azure/image15.jpeg)
...
![Imagen 16.- Creación de la conexión.](../images/configurando-administrando-nano-servers-en-microsoft-azure/image16.png)
...
![Imagen 16.- Verificación de la conexión.](../images/configurando-administrando-nano-servers-en-microsoft-azure/image17.png)
...
![Imagen 17.- Mensaje de warning relativo a la importación del certificado.](../images/configurando-administrando-nano-servers-en-microsoft-azure/image18.jpeg)
...
![Imagen 18.- Ejecución de ipconfig.](../images/configurando-administrando-nano-servers-en-microsoft-azure/image19.jpeg)
