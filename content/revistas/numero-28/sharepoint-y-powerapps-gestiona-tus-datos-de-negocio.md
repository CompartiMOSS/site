...
slug: "sharepoint-y-powerapps-gestiona-tus-datos-de-negocio"
magazineSlug: "numero-28"
author: "Sergio Hernandez Mancebo"
authorSlug: "sergio-hernandez-mancebo"
keywords: ['PowerApps','SharePoint']
image: "../images/sharepoint-y-powerapps-gestiona-tus-datos-de-negocio/image18.png"
---
...
![Imagen 1.- PowerApps conectando tu negocio.](../images/sharepoint-y-powerapps-gestiona-tus-datos-de-negocio/image1.png)
...
![Imagen 2.- Conectores disponibles.](../images/sharepoint-y-powerapps-gestiona-tus-datos-de-negocio/image2.png)
...
![Imagen 3.- Desde conector a DataSource.](../images/sharepoint-y-powerapps-gestiona-tus-datos-de-negocio/image3.png)
...
![Imagen 4.- Gestiona tus conexiones. ](../images/sharepoint-y-powerapps-gestiona-tus-datos-de-negocio/image4.png)
...
![Imagen 5.- Selecciona una nueva conexión en PowerApps.](../images/sharepoint-y-powerapps-gestiona-tus-datos-de-negocio/image5.png)

![Imagen 5.- Selecciona una nueva conexión en PowerApps.](../images/sharepoint-y-powerapps-gestiona-tus-datos-de-negocio/image6.png)
...
![Imagen 6.- Permisos para tus conexiones.](../images/sharepoint-y-powerapps-gestiona-tus-datos-de-negocio/image7.png)
...
![Imagen 7.- Añadir un nuevo control.](../images/sharepoint-y-powerapps-gestiona-tus-datos-de-negocio/image8.png)
...
![Imagen 8.- Selección de listas en SharePoint y conversión a Data Source.](../images/sharepoint-y-powerapps-gestiona-tus-datos-de-negocio/image9.png)
...
![Imagen 9.- Contenido de lista Ranking en SharePoint.](../images/sharepoint-y-powerapps-gestiona-tus-datos-de-negocio/image10.png)
...
![Imagen 10.- Añadir una nueva pantalla.](../images/sharepoint-y-powerapps-gestiona-tus-datos-de-negocio/image11.png)

2.          Añadir una galería de datos con formato vertical en nuestra nueva pantalla

![Imagen 11.- Añadir un nuevo control galería a una pantalla.](../images/sharepoint-y-powerapps-gestiona-tus-datos-de-negocio/image12.png)
...
![Imagen 12.- Añadiendo un Data Source a un control.](../images/sharepoint-y-powerapps-gestiona-tus-datos-de-negocio/image13.png)
...
![Imagen 13.- Personalizar un control galería en PowerApps.](../images/sharepoint-y-powerapps-gestiona-tus-datos-de-negocio/image14.png)
...
![Imagen 14.- Dando estilos a un control.](../images/sharepoint-y-powerapps-gestiona-tus-datos-de-negocio/image15.png)
...
![](../images/sharepoint-y-powerapps-gestiona-tus-datos-de-negocio/image18.png)
...
![Imagen 16.- Añadir el concepto Colección a una formula.](../images/sharepoint-y-powerapps-gestiona-tus-datos-de-negocio/image19.png)
...
![Imagen 17.- Colección obtenida al agrupar.](../images/sharepoint-y-powerapps-gestiona-tus-datos-de-negocio/image20.png)
...
![Imagen 18.- Contenido de una columna del tipo colección.](../images/sharepoint-y-powerapps-gestiona-tus-datos-de-negocio/image21.png)
...
![Imagen 19.- Formulas vinculadas a eventos de carga de una pantalla.](../images/sharepoint-y-powerapps-gestiona-tus-datos-de-negocio/image22.png)
...
![Imagen 20.- Fórmula para filtrar el Data Source de un control.](../images/sharepoint-y-powerapps-gestiona-tus-datos-de-negocio/image23.png)

Con todo esto tendremos como resultado la pantalla de Ranking que necesitamos para la aplicación.

![Imagen 21.- Pantallazo de la aplicación “The Critic” desarrollada en PowerApps.](../images/sharepoint-y-powerapps-gestiona-tus-datos-de-negocio/image24.png)
