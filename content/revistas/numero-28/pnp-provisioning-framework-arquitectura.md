...
slug: "pnp-provisioning-framework-arquitectura"
magazineSlug: "numero-28"
author: "Luis Mañez"
authorSlug: "luis-manez"
keywords: ['PnP']
image: "../images/pnp-provisioning-framework-arquitectura/image3.png"
---
...
![Imagen 1.- Paquetes disponibles del PnP Provisioning Framework.](../images/pnp-provisioning-framework-arquitectura/image1.png)
...
![Imagen 2.- Componentes + destacados del programa PnP.](../images/pnp-provisioning-framework-arquitectura/image2.png)
...
![](../images/pnp-provisioning-framework-arquitectura/image3.png)

E internamente, este es el proceso que ha seguido el Framework:

![Imagen 3.- Proceso interno seguido por el Framework de Provisioning.](../images/pnp-provisioning-framework-arquitectura/image4.png)
...
![](../images/pnp-provisioning-framework-arquitectura/image5.png)

Y la siguiente imagen describe el proceso aplicado:

![Imagen 4.- Proceso seguido para aplicar todas las configuraciones definidas.](../images/pnp-provisioning-framework-arquitectura/image6.png)
