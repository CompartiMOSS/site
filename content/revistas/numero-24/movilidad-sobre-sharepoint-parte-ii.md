...
slug: "movilidad-sobre-sharepoint-parte-ii"
magazineSlug: "numero-24"
author: "Ruben Toribio"
authorSlug: "ruben-toribio"
keywords: ['Movilidad','SharePoint']
image: "../images/movilidad-sobre-sharepoint-parte-ii/image13.png"
---
...
![Imagen 1.- Capas de interacción con funcionalidades nativas. ](../images/movilidad-sobre-sharepoint-parte-ii/image1.png)
...
![Imagen 2.- Tabla de funcionalidades nativas soportadas por dispositivo](../images/movilidad-sobre-sharepoint-parte-ii/image2.png)
...
![                               Imagen 3.- Añadiendo un proyecto Apache Cordova](../images/movilidad-sobre-sharepoint-parte-ii/image3.png)

- Desde el explorador de soluciones incluiremos en el proyecto un servicio conectado:

![Imagen 4.- Añadiendo un servicio conectado.](../images/movilidad-sobre-sharepoint-parte-ii/image4.png)
...
![Imagen 5.- Registrando nuestra aplicación en Azure Active Directory.](../images/movilidad-sobre-sharepoint-parte-ii/image5.png)

Una vez registrada nuestra aplicación nos aparecerá en<br />el panel de Azure nuestra aplicación, del tipo cliente nativo.

![Imagen 6.- Detalle de nuestra aplicación en Azure Active Directory.](../images/movilidad-sobre-sharepoint-parte-ii/image6.png)

- Si vemos el detalle, podremos ver el nombre de la<br />solución, el Id de cliente y la URL de la redirección.

![                                       Imagen 7.- Propiedades de nuestra aplicación en Azure Active Directory.](../images/movilidad-sobre-sharepoint-parte-ii/image7.png)
...
![Imagen 8.- Archivo JavaScript con las propiedades del servicio.](../images/movilidad-sobre-sharepoint-parte-ii/image8.png)

- En la solución de Visual Studio nos incluirá la carpeta Services con todos los scripts necesarios:

![         Imagen 9.- Archivos JavaScript agregados a través del servicio conectado.](../images/movilidad-sobre-sharepoint-parte-ii/image9.png)
...
![Imagen 10.- Características del Framework KnockoutJS.](../images/movilidad-sobre-sharepoint-parte-ii/image10.png)
...
![Imagen 11.- Separación de las capas  en el patrón MVVM.](../images/movilidad-sobre-sharepoint-parte-ii/image11.png)
...
![Imagen 12.- Lista de ejemplo donde obtendremos nuestra información](../images/movilidad-sobre-sharepoint-parte-ii/image12.png)
...
![](../images/movilidad-sobre-sharepoint-parte-ii/image13.png)
...
![](../images/movilidad-sobre-sharepoint-parte-ii/image14.png)
...
![Imagen 13.- Resultado de nuestra aplicación.](../images/movilidad-sobre-sharepoint-parte-ii/image15.png)
