...
slug: "protegiendo-vmware-con-azure-site-recovery"
magazineSlug: "numero-24"
author: "Israel Urrea Carballo"
authorSlug: "israel-urrea-carballo"
keywords: ['Azure','Site Recovery']
image: "../images/protegiendo-vmware-con-azure-site-recovery/imagen6.png"
---
...
![Imagen 1.- Etapas de madurez en modelos de computación](../images/protegiendo-vmware-con-azure-site-recovery/imagen1.png)
...
![Imagen 2.- Diagrama de Azure Site Recovery.](../images/protegiendo-vmware-con-azure-site-recovery/imagen2.png)
...
![Imagen 3.- Creación Almacén Azure Site Recovery.](../images/protegiendo-vmware-con-azure-site-recovery/imagen3.png)

![Imagen 4.- Almacén creado.](../images/protegiendo-vmware-con-azure-site-recovery/imagen4.png)
...
![Imagen 5.- Preparación VM.](../images/protegiendo-vmware-con-azure-site-recovery/imagen5.png)
...
![](../images/protegiendo-vmware-con-azure-site-recovery/imagen6.png)

Debemos indicar la IP interna así como la URL del servidor de configuración por HTTPS

![](../images/protegiendo-vmware-con-azure-site-recovery/imagen7.png)

Una vez registrado veremos una pantalla como esta:

![](../images/protegiendo-vmware-con-azure-site-recovery/imagen8.png)
...
![](../images/protegiendo-vmware-con-azure-site-recovery/imagen14.png)

Una vez instalado los agentes los veremos en la consola

![](../images/protegiendo-vmware-con-azure-site-recovery/imagen9.png)

Asignamos las redes de destino para las VMs tras la conmutación por error

![](../images/protegiendo-vmware-con-azure-site-recovery/imagen10.png)

Activamos la protección de las VMs ubicadas en la nube VMM

![](../images/protegiendo-vmware-con-azure-site-recovery/imagen11.png)

y por último, definimos el plan de recuperación, y lanzamos un test para comprobar que todo funciona adecuadamente

![](../images/protegiendo-vmware-con-azure-site-recovery/imagen12.png)

![](../images/protegiendo-vmware-con-azure-site-recovery/imagen13.png)
