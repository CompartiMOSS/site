...
![Imagen 1.- Muestra un gráfico ilustrativo para presentar datos de orígenes externos en SharePoint.](../images/busqueda-de-datos-empresariales-en-sharepoint-2013-parte-ii/image1.png)
...
![Imagen 2.- Muestra la página de las aplicaciones del servicio en el la administración central.](../images/busqueda-de-datos-empresariales-en-sharepoint-2013-parte-ii/image2.png)
...
![Imagen 4.- Muestra el formulario de nuevo origen de contenido.](../images/busqueda-de-datos-empresariales-en-sharepoint-2013-parte-ii/image4.png)
...
![Imagen 5.- Muestra el menú de opciones del origen de contenido.](../images/busqueda-de-datos-empresariales-en-sharepoint-2013-parte-ii/image5.png)
...
![Imagen 6.- Imagen P5-5: Muestra el log del rastreo del contenido.](../images/busqueda-de-datos-empresariales-en-sharepoint-2013-parte-ii/image6.png)
...
![Imagen 7.- Muestra la página de propiedades rastreada de nuestra aplicación servicio de búsqueda.](../images/busqueda-de-datos-empresariales-en-sharepoint-2013-parte-ii/image7.png)
...
![Imagen 8.- Muestra la página de propiedades administrada de nuestras aplicaciones de servicio de búsqueda.](../images/busqueda-de-datos-empresariales-en-sharepoint-2013-parte-ii/image8.png)
...
![Imagen 9.- Muestra el formulario para crear una propiedad administrada.](../images/busqueda-de-datos-empresariales-en-sharepoint-2013-parte-ii/image9.png)
...
![Imagen 10.- Muestra el formulario para realizar el mapeo con la propiedad administrada.](../images/busqueda-de-datos-empresariales-en-sharepoint-2013-parte-ii/image10.png)
...
![Imagen 11.- Muestra todas las propiedades administradas de nuestro origen de datos externo.](../images/busqueda-de-datos-empresariales-en-sharepoint-2013-parte-ii/image11.png)
...
![Imagen 12.- Muestra la página de gestión de orígenes de resultado de nuestro servicio de aplicaciones de búsqueda.](../images/busqueda-de-datos-empresariales-en-sharepoint-2013-parte-ii/image12.png)
...
![Imagen 13.- Formulario para crear un nuevo origen de resultado.](../images/busqueda-de-datos-empresariales-en-sharepoint-2013-parte-ii/image13.png)
...
![Imagen 14.- Muestra menú de opciones de configuración de sitio en nuestro centro de búsqueda.](../images/busqueda-de-datos-empresariales-en-sharepoint-2013-parte-ii/image14.png)

- Abrimos la librería de páginas. Pulsamos sobre el icono de Paginas (Pages).

![Imagen 15.- Muestra el contenido del sitio de nuestro centro de búsqueda.](../images/busqueda-de-datos-empresariales-en-sharepoint-2013-parte-ii/image15.png)
...
![Imagen 16.- Muestra el formulario para crear una nueva página en nuestro sitio de búsqueda.](../images/busqueda-de-datos-empresariales-en-sharepoint-2013-parte-ii/image16.png)

- Modificamos elemento web de resultado de búsqueda. Seleccionamos la página que acabamos de crear "ProveedoresResult"

![Imagen 17.- Muestra el formulario para crear una nueva página en nuestro sitio de búsqueda.](../images/busqueda-de-datos-empresariales-en-sharepoint-2013-parte-ii/image17.png)

Editamos el elemento web de resultado de búsqueda (Search Result) para ello tenemos que editar la página.

![Imagen 18.- Muestra la página en modo edición.](../images/busqueda-de-datos-empresariales-en-sharepoint-2013-parte-ii/image18.png)
...
![Imagen 19.- Muestra la herramienta de propiedades del elemento web de resultado de búsqueda.](../images/busqueda-de-datos-empresariales-en-sharepoint-2013-parte-ii/image19.png)
...
![Imagen 20.- Muestra menú de opciones de configuración de nuestro sitio de búsqueda.](../images/busqueda-de-datos-empresariales-en-sharepoint-2013-parte-ii/image20.png)
...
![Imagen 21.- Muestra menú de opciones en la categoría de búsqueda en nuestro sitio de búsqueda.](../images/busqueda-de-datos-empresariales-en-sharepoint-2013-parte-ii/image21.png)
...
![Imagen 22.- Muestra la página de configuración de búsqueda en nuestro sitio de búsqueda.](../images/busqueda-de-datos-empresariales-en-sharepoint-2013-parte-ii/image22.png)
...
![Imagen 23.- Muestra la página principal de nuestro sitio de búsqueda.](../images/busqueda-de-datos-empresariales-en-sharepoint-2013-parte-ii/image23.png)

- Visualizamos los resultados. Comprobamos que aparecen los resultados deseado de nuestro contenido externo de proveedores.

![Imagen 24.- Muestra la página de resultado genérico de nuestro sitio de búsqueda.](../images/busqueda-de-datos-empresariales-en-sharepoint-2013-parte-ii/image24.png)
...
![Imagen 55.- Muestra la página de resultado en el ámbito de proveedores en nuestro sitio de búsqueda.](../images/busqueda-de-datos-empresariales-en-sharepoint-2013-parte-ii/image25.png)

- Visualizamos los datos del proveedor. Como podemos comprobar presenta toda la información de nuestro proveedor.

![Imagen 26.- Muestra la página de los datos del proveedor seleccionado en nuestro sitio de búsqueda. ](../images/busqueda-de-datos-empresariales-en-sharepoint-2013-parte-ii/image26.png)
