...
slug: "integracion-continua-en-sharepoint-con-team-services-y-pnp"
magazineSlug: "numero-30"
author: "Luis Mañez"
authorSlug: "luis-manez"
keywords: ['PnP','SharePoint Online','TFS','Team Services']
image: "../images/integracion-continua-en-sharepoint-con-team-services-y-pnp/image1.png"
---

![](../images/integracion-continua-en-sharepoint-con-team-services-y-pnp/image1.png)
...
![Imagen 1.- Modelo de desarrollo para SharePoint Online.](../images/integracion-continua-en-sharepoint-con-team-services-y-pnp/image2.png)
...
![](../images/integracion-continua-en-sharepoint-con-team-services-y-pnp/image3.png)
...
![Imagen 1.- Creación de una definición de build.](../images/integracion-continua-en-sharepoint-con-team-services-y-pnp/image4.png)
...
![Imagen 2.- Selección del gestor de código fuente.](../images/integracion-continua-en-sharepoint-con-team-services-y-pnp/image5.png)
...
![Imagen 3.- Restauración de los paquetes de NuGet.](../images/integracion-continua-en-sharepoint-con-team-services-y-pnp/image6.png)
...
![Imagen 4.- Step de Build Solution generado en la plantilla.](../images/integracion-continua-en-sharepoint-con-team-services-y-pnp/image7.png)

En nuestro caso, le<br />especificamos la Solution que queremos utilizar:

![Imagen 5.- Configuración de la solución a utilizar.](../images/integracion-continua-en-sharepoint-con-team-services-y-pnp/image8.png)
...
![Imagen 6.- Restauración de los paquetes de Gulp.](../images/integracion-continua-en-sharepoint-con-team-services-y-pnp/image9.png)

Y configuraremos el Step para que apunte a nuestro proyecto (Working<br />directory) donde hacemos uso de Gulp:

![Imagen 7.- Configuración del Step para hacer uso de Gulp.](../images/integracion-continua-en-sharepoint-con-team-services-y-pnp/image10.png)

Una vez restaurados los paquetes que necesita Gulp, crearemos un nuevo Step<br />de Gulp:

![Imagen 8.- Creación del nuevo Step de Gulp.](../images/integracion-continua-en-sharepoint-con-team-services-y-pnp/image11.png)
...
![Imagen 9.- Configuración del Step de Gulp.](../images/integracion-continua-en-sharepoint-con-team-services-y-pnp/image12.png)
...
![Imagen 10.- Uso del Build Step de Command Line.](../images/integracion-continua-en-sharepoint-con-team-services-y-pnp/image13.png)
...
![Imagen 11.- Configuración del Step de Command Line](../images/integracion-continua-en-sharepoint-con-team-services-y-pnp/image14.png)
...
![Imagen 12.- Parámetros requeridos en la aplicación de consola.](../images/integracion-continua-en-sharepoint-con-team-services-y-pnp/image15.png)
...
![Imagen 13.- Configuración de la ejecución de la build.](../images/integracion-continua-en-sharepoint-con-team-services-y-pnp/image16.png)
