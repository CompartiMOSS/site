...
![Imagen 1.- Descarga de R desde Revolution Open.](../images/usando-r-script-en-power-bi/image1.png)

Una vez descargado el msi, ejecutarlo y seguir los siguientes pasos (marcados con el cursor y los steps):

![Imagen 2.- Instalador de R.](../images/usando-r-script-en-power-bi/image2.png)

Una vez iniciado el instalador, aceptar los términos y condiciones y continuar con la instalación

![Imagen 3.- Información de licencia para R.](../images/usando-r-script-en-power-bi/image3.png)
...
![Imagen 3.- Ventana para seleccionar la instalación de MKL.](../images/usando-r-script-en-power-bi/image4.png)

Si se eligió descargar *MKL*, aceptar los términos y condiciones y proseguir con la instalación.

![Imagen 4.- Acuerdo de licencia para MKL.](../images/usando-r-script-en-power-bi/image5.png)
...
![Imagen 5.- Ruta de instalación de R.](../images/usando-r-script-en-power-bi/image6.png)
...
![Imagen 6.- Inicio del proceso de instalación de R.](../images/usando-r-script-en-power-bi/image7.png)

Una vez finalizada la instalación cerrar el dialogo de instalación.

![Imagen 7.- Finalización de la instalación de R](../images/usando-r-script-en-power-bi/image8.png)
...
![Imagen 8.- Acceso a Power BI Desktop.](../images/usando-r-script-en-power-bi/image9.png)

​ ·          Una vez en la aplicación dirigirse a *Archivo (File) -&gt; Options and Settings -&gt; Options* .

![Imagen 9.- Acceso a las opciones de Power BI.](../images/usando-r-script-en-power-bi/image10.png)
...
![• Dentro de las opciones dirigirse a la pestaña R script. En la pestaña podremos ver la carpeta destino de la instalación de R-s](../images/usando-r-script-en-power-bi/image11.png)
...
![Imagen 11.- Ejemplo de uso de require para importar un módulo.](../images/usando-r-script-en-power-bi/image12.png)

Si el modulo necesario no existe o no se ha importado, Power BI mostrará el siguiente error en la ejecución del script.

![Imagen 12.- Error en Power BI si el módulo no se encuentra.](../images/usando-r-script-en-power-bi/image13.png)
...
![Imagen 13.- Solución al error que se produce cuando no se encuentra el módulo.](../images/usando-r-script-en-power-bi/image14.png)
...
![Imagen 14.- Acceso a la opción de usar una consulta R como data source de Power BI.](../images/usando-r-script-en-power-bi/image15.png)

En los orígenes disponibles tendremos la opción *R script.*

![Imagen 15.- Origen de datos R en Power BI.](../images/usando-r-script-en-power-bi/image16.png)

Una vez elegida la opción tendremos un recuadro en donde especificar la consulta R.

![Imagen 16.- Ventana para especificar la consulta R.](../images/usando-r-script-en-power-bi/image17.png)
...
​![Imagen 17.- Acceso a la opción Edit Query.](../images/usando-r-script-en-power-bi/image18.png)

·          Bajo la pestaña *Transform* , en la sección *Scripts* , encontraremos la opción R

![Imagen 18.- Opción Run R Script en la pestaña Transform.](../images/usando-r-script-en-power-bi/image19.png)
...
![Imagen 19.- Utilización de R para representaciones visuales en Power BI.](../images/usando-r-script-en-power-bi/image20.png)
...
![Imagen 20.- Importación del archivo de texto con R-Script.](../images/usando-r-script-en-power-bi/image21.png)
...
![Imagen 21.- Exportación de los datos de un visual.](../images/usando-r-script-en-power-bi/image22.png)
...
![Imagen 22.- Error mostrado cuando se excede el límite de datos a exportar.](../images/usando-r-script-en-power-bi/image23.png)
