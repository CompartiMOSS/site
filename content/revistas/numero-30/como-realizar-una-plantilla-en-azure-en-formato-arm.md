...
slug: "como-realizar-una-plantilla-en-azure-en-formato-arm"
magazineSlug: "numero-30"
author: "Luis Emilio López"
authorSlug: "luis-emilio-lopez"
keywords: ['Azure','Azure ARM']
image: "../images/como-realizar-una-plantilla-en-azure-en-formato-arm/image12.png"
---
...
![Imagen 1.- Como realizar una captura de máquina para máquinas “Classic”.](../images/como-realizar-una-plantilla-en-azure-en-formato-arm/image1.png)
...
![Imagen 2.- Creación de máquina ARM en Azure](../images/como-realizar-una-plantilla-en-azure-en-formato-arm/image2.png)
...
![Imagen 3.- Parámetros adicionales de la máquina](../images/como-realizar-una-plantilla-en-azure-en-formato-arm/image3.png)

Una vez que aceptamos los parámetros de la máquina, viene la primera parte de la magia.

![Imagen 4.- Resume den las configuraciones a aplicar.](../images/como-realizar-una-plantilla-en-azure-en-formato-arm/image4.png)

En la pantalla de resumen, tenemos abajo un enlace a:

![Imagen 5.- Enlace en la pantalla de resumen.](../images/como-realizar-una-plantilla-en-azure-en-formato-arm/image5.png)

Si pulsamos sobre él se despliega otro panel

![Imagen 6.- Panel desplegado.](../images/como-realizar-una-plantilla-en-azure-en-formato-arm/image6.png)
...
![Imagen 7.- Selección de la máquina en una suscripción.](../images/como-realizar-una-plantilla-en-azure-en-formato-arm/image7.png)

Una vez ubicada, desplegamos las suscripciones, y los grupos de recursos, y seleccionamos el grupo de corresponda.

![Imagen 8.- Grupos de recursos disponibles en Azure.](../images/como-realizar-una-plantilla-en-azure-en-formato-arm/image8.png)

Lo desplegamos, hasta llegar hasta la máquina que queremos usar como plantilla.

![Imagen 9.- Máquina a utilizar como plantilla.](../images/como-realizar-una-plantilla-en-azure-en-formato-arm/image9.png)

Una vez sobre la máquina, pulsamos sobre el botón ‘Actions (Post/Delete)’.

![Imagen 10.- Opción “Actions (POST, DELETE)”](../images/como-realizar-una-plantilla-en-azure-en-formato-arm/image10.png)

Con lo que se nos desplegaran un montón de opciones a la izquierda:

![Imagen 11.- Opciones adicionales.](../images/como-realizar-una-plantilla-en-azure-en-formato-arm/image11.png)

Desde esta ubicación, es donde capturaremos la maquina como plantilla. En primer lugar, le daremos al botón DEALLOCATE

![](../images/como-realizar-una-plantilla-en-azure-en-formato-arm/image12.png)

Con esto apagaremos para Azure a la máquina.

![Imagen 12.- Máquina parada.](../images/como-realizar-una-plantilla-en-azure-en-formato-arm/image13.png)
...
![](../images/como-realizar-una-plantilla-en-azure-en-formato-arm/image14.png)
...
![Imagen 13.- Funcionalidad de “Capture”.](../images/como-realizar-una-plantilla-en-azure-en-formato-arm/image15.png)
...
![Imagen 14.- Plantilla de máquina lista para usar.](../images/como-realizar-una-plantilla-en-azure-en-formato-arm/image16.png)

![](../images/como-realizar-una-plantilla-en-azure-en-formato-arm/image17.png)
