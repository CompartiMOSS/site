...
![Imagen 1.- Power BI Web.](../images/power-bi-conexion-con-sql-y-oracle/image1.png)

Dentro de estos orígenes se destacan los servicios para GitHub, Google Analytics, Azure, etc.

![Imagen 2.- Orígenes de datos en Power BI.](../images/power-bi-conexion-con-sql-y-oracle/image2.png)
...
![Imagen 3.- Conexiones de datos.](../images/power-bi-conexion-con-sql-y-oracle/image3.png)
...
![Imagen 4.- Selección del origen de tipo SQL Server Database.](../images/power-bi-conexion-con-sql-y-oracle/image4.png)
...
![Imagen 5.- Parámetros de conexión a la BD de SQL Server. ](../images/power-bi-conexion-con-sql-y-oracle/image5.png)
...
![Imagen 6.- Opciones avanzadas para realizar la conexión a la BD SQL Server.](../images/power-bi-conexion-con-sql-y-oracle/image6.png)
...
![Imagen 7.- Parámetros de conexión a la BD.](../images/power-bi-conexion-con-sql-y-oracle/image7.png)

… o a través de autenticación directa sobre la base de datos.

![Imagen 7.- Conexión con usuario de BD.](../images/power-bi-conexion-con-sql-y-oracle/image8.png)
...
![Imagen 8.- Versión de Power BI instalada.](../images/power-bi-conexion-con-sql-y-oracle/image9.png)
...
![ Imagen 9.- Selección del origen Oracle Database.](../images/power-bi-conexion-con-sql-y-oracle/image10.png)

Para realizar la conexión debemos ingresar la IP del servidor seguido de /[ALIAS] especificado en el archivo *TNSnames.ora*.

![Imagen 10.- Parámetro de conexión del servidor de Oracle.](../images/power-bi-conexion-con-sql-y-oracle/image11.png)

De forma análoga a SQL podremos especificar una consulta a la Base de datos en la sección *Advanced options.*

![Imagen 11.- Opciones avanzadas de conexión a Oracle.](../images/power-bi-conexion-con-sql-y-oracle/image12.png)
