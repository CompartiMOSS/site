...
slug: "integra-powerapp-con-microsoft-flow-y-custom-api"
magazineSlug: "numero-29"
author: "Sergio Hernandez Mancebo"
authorSlug: "sergio-hernandez-mancebo"
keywords: ['PowerApps','MongoDB']
image: "../images/integra-powerapp-con-microsoft-flow-y-custom-api/image17.png"
---
...
![Imagen 1.- Arquitectura de la solución.](../images/integra-powerapp-con-microsoft-flow-y-custom-api/image1.png)
...
![Imagen 2.- Creación web api desde Visual Studio.](../images/integra-powerapp-con-microsoft-flow-y-custom-api/image2.png)
...
![Imagen 3.- Añadiendo Swagger al proyecto.](../images/integra-powerapp-con-microsoft-flow-y-custom-api/image3.png)
...
![Imagen 4.- Utilizando Swagger.](../images/integra-powerapp-con-microsoft-flow-y-custom-api/image4.png)
...
![Imagen 5.- Registro de una API en PowerApps.](../images/integra-powerapp-con-microsoft-flow-y-custom-api/image5.png)
...
![Imagen 6.- Añadir conexión a las App en PowerApps.](../images/integra-powerapp-con-microsoft-flow-y-custom-api/image6.png)
...
![Imagen 7.- Modelo base de datos en Mongo DB.](../images/integra-powerapp-con-microsoft-flow-y-custom-api/image7.png)
...
![Imagen 8.- Estructura de la solución.](../images/integra-powerapp-con-microsoft-flow-y-custom-api/image8.png)
...
![Imagen 9.- Paquetes necesarios para implementar MongoRepository](../images/integra-powerapp-con-microsoft-flow-y-custom-api/image9.png)
...
![Imagen 10.- Iniciando un Microsoft Flow.](../images/integra-powerapp-con-microsoft-flow-y-custom-api/image10.png)
...
![Imagen 11. Conectando un Microsoft Flow a una custom API.](../images/integra-powerapp-con-microsoft-flow-y-custom-api/image11.png)
...
![Imagen 12. Petición POST contra una custom API.](../images/integra-powerapp-con-microsoft-flow-y-custom-api/image12.png)
...
![Figura 13.- Seguimiento de un Flow.](../images/integra-powerapp-con-microsoft-flow-y-custom-api/image13.png)
...
![Imagen 14.- Añadir un API como DataSource.](../images/integra-powerapp-con-microsoft-flow-y-custom-api/image14.png)

Como adelantamos al inicio la primera pantalla de la APP es el listado de usuarios.

![Imagen 15.- Listado de contactos.](../images/integra-powerapp-con-microsoft-flow-y-custom-api/image15.png)
...
![Imagen 16. Pantalla detalle contacto y entradas.](../images/integra-powerapp-con-microsoft-flow-y-custom-api/image16.png)
...
![](../images/integra-powerapp-con-microsoft-flow-y-custom-api/image17.png)

![Figura 17.- Pantalla añadir contacto.](../images/integra-powerapp-con-microsoft-flow-y-custom-api/image18.png)
