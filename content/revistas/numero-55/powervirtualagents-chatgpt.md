...
![](../images/powervirtualagents-chatgpt/image6.png) luego hacemos Click en "**Call an
Action"** y "**Create a Flow**".

![](../images/powervirtualagents-chatgpt/image7.png)

Se nos abrirá la pantalla de Power Automate:

![](../images/powervirtualagents-chatgpt/image8.png)
...
![](../images/powervirtualagents-chatgpt/image9.png)

Agregamos una acción del tipo **"GPT3 Completes your prompt"**

![](../images/powervirtualagents-chatgpt/image10.png)

Nos aparecerá la siguiente sección para generar la conexión con OpenAI:

![](../images/powervirtualagents-chatgpt/image11.png)
...
![](../images/powervirtualagents-chatgpt/image15.png)

Definimos una variable para guardar la respuesta:

![d](../images/powervirtualagents-chatgpt/image16.png)

Agregamos un Apply to each y seleccionamos la colección a iterar
"Choices":

![](../images/powervirtualagents-chatgpt/image17.png)

![](../images/powervirtualagents-chatgpt/image18.png)
...
![](../images/powervirtualagents-chatgpt/image20.png)

Por último, solo falta retornar la respuesta al Power Virtual Agent

![](../images/powervirtualagents-chatgpt/image21.png)
