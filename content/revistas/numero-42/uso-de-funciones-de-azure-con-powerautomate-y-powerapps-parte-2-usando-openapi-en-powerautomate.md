...
![Imagen 1.- Exportar la definición de OpenAPI desde Azure.](../images/uso-de-funciones-de-azure-con-powerautomate-y-powerapps-parte-2-usando-openapi-en-powerautomate/image1.png)
...
![Imagen 2.- Importar la definición de OpenAPI. ](../images/uso-de-funciones-de-azure-con-powerautomate-y-powerapps-parte-2-usando-openapi-en-powerautomate/image2.png)
...
![Imagen 3.- Creación del flujo. ](../images/uso-de-funciones-de-azure-con-powerautomate-y-powerapps-parte-2-usando-openapi-en-powerautomate/image3.png)

9. Después de seleccionar el conector aparece su ventana de configuración para crear una conexión con el conector:​

![Imagen 4.- Creación de una conexión para el conector ](../images/uso-de-funciones-de-azure-con-powerautomate-y-powerapps-parte-2-usando-openapi-en-powerautomate/image4.png)
...
![Imagen 6.- Ventana de configuración de la llamada al API Management.](../images/uso-de-funciones-de-azure-con-powerautomate-y-powerapps-parte-2-usando-openapi-en-powerautomate/image5.png)
...
![Imagen 7.- Ventana de configuración del email en Outlook. ](../images/uso-de-funciones-de-azure-con-powerautomate-y-powerapps-parte-2-usando-openapi-en-powerautomate/image6.png)
...
![Imagen 8.- Resumen del Flujo después de funcionar. ](../images/uso-de-funciones-de-azure-con-powerautomate-y-powerapps-parte-2-usando-openapi-en-powerautomate/image7.png)
...
![Imagen 9.- La Función de Azure trabajando con los datos del Flujo. ](../images/uso-de-funciones-de-azure-con-powerautomate-y-powerapps-parte-2-usando-openapi-en-powerautomate/image8.png)

Finalmente, el flujo envía un Email a la cuenta configurada indicando el valor generado por la función:

![Imagen 10.- El email enviado por el flujo con los resultados de la Función.](../images/uso-de-funciones-de-azure-con-powerautomate-y-powerapps-parte-2-usando-openapi-en-powerautomate/image9.png)
