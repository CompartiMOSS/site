...
![Imagen 1.- Diagrama de la arquitectura de Microsoft Bot Framework.](../images/chatbots-al-rescate/image1.png)
...
![Imagen 2. – Flujo de creación del Web App Bot.](../images/chatbots-al-rescate/image2.png)
...
![Imagen 3. – Permisos para la App registrada en Azure Active Directory.](../images/chatbots-al-rescate/image3.png)
...
![Imagen 4. – Método de renderizado de la extensión de SPFX.](../images/chatbots-al-rescate/image4.png)
...
![Imagen 5. – Definición de la variable DirectLine del Bot.](../images/chatbots-al-rescate/image5.png)
...
![Imagen 6. – Recuperación del token para la aplicación registrada en Azure AD.](../images/chatbots-al-rescate/image6.png)

![Imagen 7. – Definición del método getToken().](../images/chatbots-al-rescate/image7.png)
...
![Imagen 8. – Petición de permisos sobre Office 365 desde extensión de SPFx.](../images/chatbots-al-rescate/image8.png)
...
![Imagen 9. – Switch para identificar los tipos de evento que desencadenan una acción.](../images/chatbots-al-rescate/image9.png)
...
![Imagen 9. – Página de SharePoint Online con la extensión de Bot en la parte inferior derecha.](../images/chatbots-al-rescate/image10.png)
...
![Imagen 10. – Petición de información genérica al Bot con respuesta de QnAMaker.](../images/chatbots-al-rescate/image11.png)

![Imagen 11. – Petición de las ultimas noticias y respuesta en carrousel de AdaptiveCards.](../images/chatbots-al-rescate/image12.png)

![Imagen 12. – Petición de las ultimas 3 nominas y respuesta en formato carrousel.](../images/chatbots-al-rescate/image13.png)

![Imagen 13. – Petición de vacaciones en formato AdaptiveCard y envío de solicitud.](../images/chatbots-al-rescate/image14.png)
...
![Imagen 14. – Conversación con el Bot desde MS Teams e interacción con los mensajes recibidos.](../images/chatbots-al-rescate/image15.png)
