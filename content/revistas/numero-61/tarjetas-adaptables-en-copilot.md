...
slug: "tarjetas-adaptables-en-copilot"
...
image: "../images/tarjetas-adaptables-en-copilot/image15.png"
---
...
![**Imagen 1.- Diseñador de tarjetas adaptables provisto por Microsoft y tarjeta base a utilizar.**](../images/tarjetas-adaptables-en-copilot/image1.png)
...
![**Imagen 2.- Entorno de creación de Copilot Studio.**](../images/tarjetas-adaptables-en-copilot/image2.png)
...
![**Imagen 4.- Temas por defecto y agregar nuevo tema.**](../images/tarjetas-adaptables-en-copilot/image3.png)

En este ejemplo, vamos a llamar a nuestro tema "Clima".

![**Imagen 5.- Detalle del Tema.**](../images/tarjetas-adaptables-en-copilot/image4.png)
...
![**Imagen 7.- Definiendo frases desencadenadoras.**](../images/tarjetas-adaptables-en-copilot/image5.png)
...
![**Imagen 8.- Configuración de pregunta en Copilot Studio.**](../images/tarjetas-adaptables-en-copilot/image6.png)
...
![**Imagen 9.- Fórmula para configurar la API.**](../images/tarjetas-adaptables-en-copilot/image7.png)

![**Imagen 10.- Variable configurada**](../images/tarjetas-adaptables-en-copilot/image8.png)

Ahora, agregamos la llamada http de la API, nuevamente pulsamos en "+" y
nos dirigimos a "Avanzados" => "Enviar solicitud http".

![**Imagen 11.- Configuración llamada http.**](../images/tarjetas-adaptables-en-copilot/image9.png)
...
![**Imagen 12.- JSON a configurar.**](../images/tarjetas-adaptables-en-copilot/image10.png)

![**Imagen 12.- JSON a configurar.**](../images/tarjetas-adaptables-en-copilot/image11.png)
...
![**Imagen 13.- Configuración de mensaje a enviar.**](../images/tarjetas-adaptables-en-copilot/image12.png)
...
![**Imagen 14.- Edición del JSON.**](../images/tarjetas-adaptables-en-copilot/image13.png)

Como último paso, probamos nuestro Bot , ingresando una de las frases
desencadenadoras.

![**Imagen 14.- Probando el bot.**](../images/tarjetas-adaptables-en-copilot/image14.png)

![](../images/tarjetas-adaptables-en-copilot/image15.png)
