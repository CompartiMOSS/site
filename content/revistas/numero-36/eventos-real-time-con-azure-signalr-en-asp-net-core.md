...
![Imagen 1.- Arquitectura SignalR.](../images/eventos-real-time-con-azure-signalr-en-asp-net-core/image1.png)
...
![Imagen 2.- Mapa lógico de envíos.](../images/eventos-real-time-con-azure-signalr-en-asp-net-core/image2.png)
...
![Imagen 3.- Nueva arquitectura de envíos, Azure como backend.](../images/eventos-real-time-con-azure-signalr-en-asp-net-core/image3.png)
...
![Imagen 4.- Autenticación en el servicio.](../images/eventos-real-time-con-azure-signalr-en-asp-net-core/image4.png)
...
![Imagen 5.- Ejemplo completo de envío.](../images/eventos-real-time-con-azure-signalr-en-asp-net-core/image5.png)
...
![Imagen 6.- Creando la solución.](../images/eventos-real-time-con-azure-signalr-en-asp-net-core/image6.png)
...
![Imagen 7.- Registrando signalR.js.](../images/eventos-real-time-con-azure-signalr-en-asp-net-core/image7.png)

1.       En el fichero startup.cs deberemos modificar los métodos:

·       ConfigureServices:

![Imagen 8.- Configurando la app y los servicios a inyectar.](../images/eventos-real-time-con-azure-signalr-en-asp-net-core/image8.png)
...
![Imagen 9.- Definiendo el hub.](../images/eventos-real-time-con-azure-signalr-en-asp-net-core/image9.png)
...
![Imagen 10.- Clase hub de SignalR.](../images/eventos-real-time-con-azure-signalr-en-asp-net-core/image10.png)
...
![Imagen 11.- Script cliente, proxyHub.](../images/eventos-real-time-con-azure-signalr-en-asp-net-core/image11.png)
...
![Imagen 12.- traza en el navegador, websokect.](../images/eventos-real-time-con-azure-signalr-en-asp-net-core/image12.png)
...
![Imagen 13.- Servicio en azure, plan de precios.](../images/eventos-real-time-con-azure-signalr-en-asp-net-core/image13.png)
...
![Imagen 14.- Cadenas de conexión.](../images/eventos-real-time-con-azure-signalr-en-asp-net-core/image14.png)
...
![Imagen 15.- Fichero de configuración en .NET Core.](../images/eventos-real-time-con-azure-signalr-en-asp-net-core/image15.png)
...
![Imagen 16.- Prueba desde MVC Controller.](../images/eventos-real-time-con-azure-signalr-en-asp-net-core/image16.png)
...
![Imagen 17.- Inyectando el HubContext.](../images/eventos-real-time-con-azure-signalr-en-asp-net-core/image17.png)
...
![Imagen 18.- Resultado de la demo, ok.](../images/eventos-real-time-con-azure-signalr-en-asp-net-core/image18.png)
...
![Imagen 19.- Habilitando websocket.](../images/eventos-real-time-con-azure-signalr-en-asp-net-core/image19.png)

Ahora vamos a crear una aplicación de consola, y la añadiremos a nuestra solución con el siguiente código:

![Imagen 20.- Program.cs.](../images/eventos-real-time-con-azure-signalr-en-asp-net-core/image20.png)
...
![Imagen 21.- JWT para obtener bearer.](../images/eventos-real-time-con-azure-signalr-en-asp-net-core/image21.png)

Además, va a realizar un POST con el mensaje a trasmitir, que en este caso recoge por consola.

![Imagen 22.- Post del mensaje al servicio.](../images/eventos-real-time-con-azure-signalr-en-asp-net-core/image22.png)
...
![Imagen 23.- Demo final desde console.](../images/eventos-real-time-con-azure-signalr-en-asp-net-core/image23.png)
